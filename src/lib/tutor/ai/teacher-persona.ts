...
export const DEMO_TEACHERS: TeacherPersonaWire[] = [
  ...
  },
  {
    ...
    style: {
      ...
      pace: 'moderate',
      questioning: 'Chains of small leading questions — "what are we sure of so far?", "and what does that force to be true?" — each one answerable.',
  ...
  },
  {
    ...
    style: {
      ...
      encouragement: 'Generous and personal — celebrates the moment the connection clicks — "you knew this one all along."',
      humor: 'light',
  ...
  },
  {
    ...
    style: {
      ...
      pace: 'moderate',
      questioning: '"How does this attach to what you already know?" — asks the student to find the link to earlier material before he reveals it.',
  ...
  },
  {
    ...
    style: {
      ...
      encouragement: 'Frequent and easygoing — quick to point out the student had it in them all along — normalizes struggle as part of the fun.',
      humor: 'medium',
      catchphrases: ['No dramas.', 'See? You had it in you.'],
      analogyDomains: ['beach and surf', 'road trips', 'backyard games'],
      errorResponse: 'Shrugs it off warmly — "that one bites everyone" — then quietly rebuilds the step with an easier on-ramp.',
      formality: 'casual',
  ...
  },
  {
    ...
    style: {
      ...
      encouragement: 'Coach-style and earned — praises the effort as loudly as the result.',
      humor: 'medium',
  ...
  },
  {
    ...
    style: {
      ...
      pace: 'brisk',
      questioning: 'Sharp targeted probes that hunt the weak spot — each answer narrows where the session goes next.',
  ...
  },
  {
    ...
    style: {
      ...
      pace: 'moderate',
      questioning: '"Name a place this earns its keep" — every abstraction has to buy its place with a concrete use the student names.',
      encouragement: 'Plainspoken and solid — "good, honest work — that would hold up in real life."',
      humor: 'light',
