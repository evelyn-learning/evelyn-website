/**
 * World History — Unit 5 CED 5.1: West African Empires: Ghana, Mali & Songhai.
 *
 * Auto-extracted from the corresponding lesson plan
 * (evelyn.hs.whist.west-african-empires.v1). Hand-edit freely after extraction; bump
  ...
  methods: [
    {
      ...
      example: { problem: `Build the causal chain: how did a desert — the least productive land in the region — end up producing three of the wealthiest empires in the medieval world?`, solution: `Opposite shortages (gold south, salt north) plus the camel made regular crossings profitable; empires grew by taxing the choke points that trade had to pass through, and converted that revenue into armies, cities, and scholarship.` },
      relatedLoIds: ['whist.west-african-empires'],
    },
    {
      title: 'Worked cairo account',
      steps: [
      ...
      example: { problem: `An Egyptian official writing in Cairo about fifteen years after the event described Mansa Musa's visit roughly this way: "He left no royal officeholder without a gift of gold, and the merchants of the city made fortunes buying and selling with his people. So much gold changed hands that its price in Egypt fell and had not recovered." Work out what this tells us — and what it does not.`, solution: `It is strong contemporary evidence that Mali's gold wealth was large enough to move a major foreign market and to make Mali famous across the Mediterranean world; the specific claim of a years-long price depression is a secondhand impression rather than a measurement, so use it for scale, not for precision.` },
      relatedLoIds: ['whist.west-african-empires'],
    },
  ],
  pointers: [
    { content: `Every part of "West Africa had no cities, writing, or states before European arrival" fails on the evidence. Cities: Timbuktu, Djenne, and Gao were substantial urban centers with markets, mosques, and schools. Writing: Timbuktu families held manuscript libraries in Arabic and in local languages written in Arabic script, and tens of thousands of those books survive. States: Ghana, Mali, and Songhai were tax-collecting empires with armies, governors, and standardized administration. And the record is rich: griot oral tradition preserved the Epic of Sundiata, and outside writers such as Ibn Battuta and an Egyptian official recording Mansa Musa in Cairo describe Mali firsthand. West Africa was wealthy, urban, literate, and internationally known long before European contact.`, kind: 'common-error' },
    { content: `The camel and its desert saddle turned the Sahara from a barrier into a trade corridor; gold moved north, salt moved south, because each side lacked what the other had.`, kind: 'tip' },
    { content: `Ghana (c. 700-1200), Mali (c. 1235-1600, founded by Sundiata), and Songhai (c. 1464-1591, built by Sunni Ali and organized by Askia Muhammad) all grew rich the same way: taxing trade at the choke points, not owning the mines.`, kind: 'tip' },
    { content: `Mansa Musa's hajj of 1324-25 gave away enough gold to depress Cairo's prices for years and put Mali on European maps by 1375.`, kind: 'tip' },
    { content: `Timbuktu converted trade wealth into scholarship — Sankore and family manuscript libraries made it a leading center of Islamic learning.`, kind: 'tip' },
    { content: `Islam spread along the caravan routes and blended with local traditions rather than erasing them; griots and the Epic of Sundiata preserved history alongside written accounts.`, kind: 'tip' },
    { content: `Songhai fell in 1591 to Moroccan gunpowder at Tondibi — an ending caused by weapons technology, not by any lack of wealth or organization.`, kind: 'tip' },
    { content: `The medieval Empire of Ghana was **not** in the modern country of Ghana — it sat in today's Mali and Mauritania. Modern Ghana took the name in 1957 as a tribute. Same for Mali: the empire's territory doesn't match the modern borders.`, kind: 'common-error' },
    { content: `Say "taxed the trade," not "owned the gold." Ghana, Mali, and Songhai got rich controlling choke points — markets, river crossings, caravan stops — not mines. Miners in Bambuk and Bure stayed deliberately obscure and outside imperial control.`, kind: 'common-error' },
    { content: `Salt traded near gold's weight because it preserves food and replaces what you sweat out in heat — it's survival, not seasoning. Don't write that West Africans 'overvalued' salt or were tricked; the exchange was rational on both sides.`, kind: 'vocab-note' },
    { content: `Songhai fell to a Moroccan gunpowder army at Tondibi in 1591 — it was **not** in decline and was **not** conquered by Europeans. Don't attach the usual 'internal decay' story to an empire that lost a battle to superior weapons technology.`, kind: 'gotcha' },
    { content: `"Oral" ≠ "unreliable." Griots trained for years and were held accountable by their communities. Cross-check the *Epic of Sundiata* against Ibn Battuta or Cairo accounts the way you'd cross-check any two written sources — don't rank written above oral by default.`, kind: 'vocab-note' },
    { content: `Sahel and Sahara are different places. The Sahel is the semi-arid grassland belt *south* of the desert where Timbuktu, Djenne, and Gao sat. Empires were built in the Sahel, at the desert's southern edge — not in the Sahara itself.`, kind: 'vocab-note' },
    { content: `Islam layered onto local practice rather than replacing it — rulers and city merchants converted early, rural traditions persisted. Avoid "West Africa converted to Islam" as a flat statement; specify who, where, and how deep.`, kind: 'edge-case' },
    { content: `Use the Cairo gold-price story for **scale**, not precision. The writer was in Cairo about fifteen years later, working from testimony with no price records. "Prices hadn't recovered" is a strong impression; "Mansa Musa gave away enormous gold" is corroborated.`, kind: 'tip' },
  ],
};
