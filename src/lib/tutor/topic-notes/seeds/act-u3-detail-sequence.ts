...
export const BASELINE_ACT_U3_DETAIL_SEQUENCE: TopicNotesBaseline = {
  ...
  theory: [
    ...
    { loId: 'act.detail-sequence', content: `PACE CHECK: at ~67 seconds per question, line-reference and sequence questions should be some of your FASTEST. The answer is locatable in the text — verify and move on, don't overthink.` },
...
Question: Which lists the events in the order they actually happened, earliest to latest?`, solution: 'I, II, III' },
  ...
  pointers: [
    ...
    { content: `At ~67 seconds a question, these should be your fastest points: verify against the text and move on.`, kind: 'tip' },
