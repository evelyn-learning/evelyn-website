...
export const BASELINE_ACT_U3_READING_PACING_STRATEGY: TopicNotesBaseline = {
  ...
  theory: [
    { loId: 'act.reading-pacing-strategy', content: `THE MATH: 35 minutes ÷ 4 passages = ~8:45 per passage; 35 minutes ÷ 40 questions = ~52 seconds per question. No bell rings between passages — you self-pace.` },
    ...
    { loId: 'act.reading-pacing-strategy', kind: 'framework', title: 'Trap', content: `TRAP — SUNK COST: pouring extra minutes into a hard passage because you refuse to move on. One passage running 12 minutes instead of 8:45 steals over 3 minutes from the other three combined.` },
  ...
  methods: [
    {
      ...
      example: { problem: `Section starts. Printed order: Prose Fiction, Social Science, Humanities, Natural Science. Your 10-second scan: Prose Fiction is a family-dinner scene (your strength); Social Science is about trade tariffs (comfortable); Humanities is a jazz musician's biography (comfortable); Natural Science is about photosynthesis experiments with two data tables (your weak spot — you missed several data questions on your last practice test). Choose your passage order and time checkpoints.`, solution: `Order: Prose Fiction → Social Science → Humanities → Natural Science, ~8:45 each, weakest genre last with a hard stop at 35 minutes.` },
    ...
    },
    {
      ...
      example: { problem: `You start with Social Science, your second-strongest genre. It has three dense data tables. At your 9-minute checkpoint you've only answered 5 of 10 questions, and you feel like just 3 more minutes would let you finish with full understanding. What should you do?`, solution: `Guess your best answer at the 9-minute checkpoint and move on — never let one dense passage eat into passages you could otherwise ace.` },
      relatedLoIds: ['act.reading-pacing-strategy'],
    },
  ],
  pointers: [
    ...
    { content: `4 passages, 40 questions, 35 minutes: ~8:45 per passage, ~52 seconds per question — a flat budget no matter the order.`, kind: 'tip' },
    ...
    { content: `Checkpoints are cumulative clock times (9, 18, 27, 35), not "9 minutes per passage." If passage one ends at 7:30, your next checkpoint is still 18 — bank the extra 1:30 for your weakest passage instead of spending it.`, kind: 'common-error' },
