...
export const BASELINE_ALG1_U6_EXPONENTIAL_FUNCTIONS: TopicNotesBaseline = {
  ...
  pointers: [
    { content: `No. At x = 2, 2·5² = 2·25 = 50, while 10² = 100. Order of operations raises b to the power FIRST, then multiplies by a. Their y-intercepts differ too: 2·5⁰ = 2 versus 10⁰ = 1.`, kind: 'common-error' },
