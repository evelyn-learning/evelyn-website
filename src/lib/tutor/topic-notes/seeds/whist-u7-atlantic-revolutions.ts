/**
 * World History — Unit 7 CED 7.4: The Atlantic Revolutions.
 *
 * Auto-extracted from the corresponding lesson plan
 * (evelyn.hs.whist.atlantic-revolutions.v1). Hand-edit freely after extraction; bump
...
export const BASELINE_WHIST_U7_ATLANTIC_REVOLUTIONS: TopicNotesBaseline = {
  ...
  theory: [
    ...
    { loId: 'whist.atlantic-revolutions', kind: 'framework', title: 'The pattern', content: `THE PATTERN — each revolution radicalized the next: American natural-rights language traveled to Paris, Paris's Declaration traveled to Saint-Domingue, and Haiti proved the words were dangerous to anyone who did not mean them. And each revolution drew its own line — property qualifications on voting, slavery preserved in the new United States and re-imposed in French colonies, women excluded nearly everywhere, indigenous and mixed-race majorities still governed by creoles. The gap between the language and the delivery is not a footnote to this era; it is the engine of the next two centuries of reform movements.` },
    { loId: 'whist.atlantic-revolutions', kind: 'definition', title: 'Estates-General', content: `France's old assembly of the three estates — clergy, nobility, and everyone else — summoned in 1789 after 175 years because the crown was out of money.` },
    { loId: 'whist.atlantic-revolutions', kind: 'definition', title: 'creole', content: `in Spanish America, a person of Spanish descent born in the Americas — often rich, but shut out of the highest colonial offices, which went to Spain-born officials.` },
    { loId: 'whist.atlantic-revolutions', kind: 'definition', title: 'Napoleonic Code', content: `Napoleon's 1804 civil law code: one written law for all men, equality before the courts, no feudal privilege — spread across the territories he conquered, and silent on the rights of women and the enslaved.` },
  ],
  methods: [
    {
      title: 'Worked debt chain',
      steps: [
      ...
      example: { problem: `Build the causal chain: how did Britain WINNING the Seven Years' War in 1763 help destroy the French monarchy in 1789?`, solution: `Britain's victory produced a debt it passed to the colonies as taxes, the colonies rebelled, France bankrolled that rebellion out of rivalry, and the resulting bankruptcy forced Louis XVI to call the Estates-General — the meeting that became the French Revolution.` },
      relatedLoIds: ['whist.atlantic-revolutions'],
    },
    {
      title: 'Worked creole grievance',
      steps: [
      ...
      example: { problem: `A Spanish American independence leader wrote in 1815 (paraphrased in modern wording): "We were never permitted to govern our own provinces, only rarely made bishops, never sent abroad as ambassadors, and allowed into the army only as junior officers. We were strangers holding the lowest offices in the land of our birth." Work out what this complaint tells you about who led Latin American independence — and what it does not tell you.`, solution: `The complaint is a catalog of blocked OFFICES, so it identifies the movement as creole-led — an elite grievance about exclusion from colonial power, not a demand to remake colonial society. That explains why independence changed who governed far more than it changed the hierarchy being governed.` },
      relatedLoIds: ['whist.atlantic-revolutions'],
    },
  ],
  pointers: [
    { content: `Napoleon did both, and the "both" is the point. He ended the revolution as a popular movement — seizing power in 1799, crowning himself emperor in 1804, censoring the press — and he re-imposed empire abroad. But he did NOT restore the old regime: the Napoleonic Code carried equality before the law, careers open to talent, and the abolition of feudal privilege into every territory his armies reached, which is why kings kept fighting him and reformers kept quoting him. And the sharpest correction is the third piece: in 1802 he RESTORED SLAVERY in France's colonies, which is precisely what pushed Saint-Domingue to fight to full independence in 1804.`, kind: 'common-error' },
    { content: `One wave, not four stories: Enlightenment natural-rights arguments plus imperial war debt lit the same fuse around the Atlantic between 1775 and 1825.`, kind: 'tip' },
    { content: `The boomerang: Britain's war debt taxed the colonies into revolt (1776), France funded that revolt out of rivalry, and the resulting bankruptcy forced the Estates-General in 1789.`, kind: 'tip' },
    { content: `France in sequence: Estates-General to National Assembly to Declaration of the Rights of Man (1789), then radicalization and the Terror (1793-94) under Robespierre, then Napoleon — Code and empire, legal equality and restored colonial slavery, at the same time.`, kind: 'tip' },
    { content: `Haiti (1791-1804) is the pivot: enslaved people led by Toussaint Louverture took the rights of man literally and won — the only successful large-scale slave revolution and the first Black republic, then punished with isolation and an indemnity by slaveholding powers.`, kind: 'tip' },
    { content: `Latin America (1810s-20s): Napoleon's invasion of Spain opened the door; Bolivar, San Martin, and Hidalgo led creole-dominated movements that won independence while leaving the social hierarchy standing.`, kind: 'tip' },
    { content: `The through-line to carry forward: every one of these revolutions wrote universal language and then narrowed it by property, race, and gender — and closing that gap is the story of the reform movements ahead.`, kind: 'tip' },
    { content: `Don't say the French Revolution "caused" the Haitian Revolution and stop there. Saint-Domingue's enslaved majority used the Declaration of the Rights of Man against France — the ideas traveled, the liberation was seized, not granted. Napoleon's 1802 restoration of slavery proves France never intended it.`, kind: 'common-error' },
    { content: `"Creole" here means American-born of **Spanish descent** — not mixed-race, not Caribbean-language, not "born in the colonies" generally. Their grievance was blocked access to top offices held by Spain-born *peninsulares*, not the racial hierarchy below them.`, kind: 'vocab-note' },
    { content: `Napoleon is not a simple reversal of the Revolution. Write him as both: Napoleonic Code (legal equality, careers open to talent, no feudal privilege) AND emperor, censorship, slavery restored in the colonies in 1802. An answer that picks only one side is incomplete.`, kind: 'gotcha' },
    { content: `Britain **won** the Seven Years' War — the debt chain starts with victory, not defeat. A global war on that scale roughly doubled Britain's debt, which is why winners tax colonists. Don't reverse the outcome to make the causation feel intuitive.`, kind: 'common-error' },
    { content: `"No taxation without representation" was a **constitutional** claim first — colonists demanded rights as Englishmen, not independence. Independence hardened only after 1775. Don't collapse 1765–1776 into one continuous independence movement.`, kind: 'edge-case' },
    { content: `Keep the Estates-General, the National Assembly, and the Committee of Public Safety straight and in order: 1789 tax body → breakaway legislature that issues the Declaration of the Rights of Man → 1793–94 Terror body under Robespierre. They are four years and a regime change apart.`, kind: 'vocab-note' },
    { content: `Independence and social revolution are not the same measurement. Ask two questions of each case: who now governs, and did the hierarchy underneath change? Latin America: yes / no. Haiti: yes / yes. That contrast is the whole point of the comparison.`, kind: 'tip' },
    { content: `Haiti's 1804 independence didn't end the story — non-recognition by slaveholding powers including the U.S., economic isolation, and France's 1825 indemnity are part of the outcome. Stopping at "they won" misses why the first Black republic was punished for winning.`, kind: 'edge-case' },
  ],
};
