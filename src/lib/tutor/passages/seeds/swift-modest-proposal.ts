 ...
 * claim. Verbatim public-domain excerpt: the earnest, statistic-laden set-up
 * followed by the deadpan ironic proposal itself (the "delicious nourishing
 * and wholesome food" turn) that is the standard evidence for Swiftian irony.
 * Genre: satirical essay/pamphlet.
 */
