 ...
 * Sultanate, the Zagwe dynasty's rock-hewn churches of Lalibela and the
 * Solomonic dynasty's claim of descent from the biblical Solomon, the
 * Khmer Empire's temple-building, and medieval Europe's independent,
 * power-CHECKING Catholic Church — scored against the authentic AP World
 * 6-point LEQ rubric.
 */
      ...
      rubric: {
        parts: [
          ...
          },
          {
            ...
            maxPoints: 2,
            scoringCriteria:
              'Full credit (2/2): uses specific, accurate historical evidence (e.g. Neo-Confucianism\'s role in the civil-service exam, the ulama/madrasa networks and qadis of Dar al-Islam and the Delhi Sultanate, Sufi conversion, the Zagwe dynasty\'s rock-hewn churches of Lalibela and the Solomonic dynasty\'s claim of descent from Solomon, the Khmer Empire\'s Angkor Wat, medieval Europe\'s independent Catholic Church) to support an argument in response to the prompt. 1/2: includes at least two specific, accurate facts relevant to the topic, whether or not they are clearly used to support an argument. 0/2: fewer than two specific facts, or evidence that is inaccurate or not relevant to the topic.',
            modelResponse:
              "Neo-Confucianism became the core curriculum of China's civil-service exam, tying access to office to mastery of a religiously-inflected philosophy; the ulama and madrasa networks across Dar al-Islam trained the qadis who administered Islamic law for states like the Delhi Sultanate; the Zagwe dynasty carved the rock-hewn churches of Lalibela (~1200s); the Solomonic dynasty that displaced it in 1270 claimed descent from the biblical Solomon to legitimize its own new throne; the Khmer Empire's Angkor Wat, built as a Hindu temple and later adapted for Buddhist worship, projected royal legitimacy through religious architecture; and medieval Europe's Catholic Church held independent political and economic authority that repeatedly checked royal power.",
          },
          {
