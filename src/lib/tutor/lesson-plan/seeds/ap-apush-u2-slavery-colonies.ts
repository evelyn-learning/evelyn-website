...
export const SEED_AP_APUSH_U2_SLAVERY_COLONIES: LessonPlan = {
  ...
  segments: [
    ...
    },
    {
      ...
      kind: 'worked_example',
      problem:
        'Analyze this excerpt from Olaudah Equiano\'s "The Interesting Narrative" (1789): "The first object which saluted my eyes when I arrived on the coast was the sea, and a slave ship… I was immediately handled and tossed up to see if I were sound by some of the crew… I saw a large furnace or copper boiling, and a multitude of black people of every description chained together, every one of their countenances expressing dejection and sorrow, I no longer doubted of my fate; and, quite overpowered with horror and anguish, I fell motionless on the deck and fainted." What is Equiano documenting, and how was this testimony later used?',
      steps: [
