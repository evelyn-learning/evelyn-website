      ...
      rubric: {
        parts: [
          ...
          },
          {
            ...
            maxPoints: 1,
            scoringCriteria:
              'Full credit (1/1): draws a conclusion comparing women\'s 2021 congressional share (roughly 27%, 147 of 535) to their population share (50.8%), concluding that women remain significantly underrepresented in Congress relative to the population despite the growth described in (B). No credit (0/1) for a response that only restates the congressional numbers without the population comparison, or that cites a population figure not in the table.',
            modelResponse:
              "In 2021, 147 of 535 voting members of Congress were women — roughly 27% — well below women's approximately 50.8% share of the U.S. population, so despite six decades of substantial growth, women remain significantly underrepresented in Congress relative to their share of the population.",
          },
          {
