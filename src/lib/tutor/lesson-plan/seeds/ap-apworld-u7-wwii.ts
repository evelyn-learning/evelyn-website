...
export const SEED_AP_APWORLD_U7_WWII: LessonPlan = {
  ...
  segments: [
    ...
    },
    {
      ...
      steps: [
        'SOURCE IT FIRST. Delivered by President Roosevelt to Congress on 6 January 1941 — nearly a year before Pearl Harbor and formal US entry into the war, while the United States was still formally neutral and aiding Britain under cash-and-carry (the Lend-Lease bill was proposed to Congress days later and signed that March).',
