      ...
      rubric: {
        parts: [
          ...
          },
          {
            ...
            modelResponse:
              'The Indian Removal Act (1830), which Jackson championed and used to forcibly remove several Southeastern nations from their homelands — defying a favorable Supreme Court ruling in Worcester v. Georgia in the process, though the Cherokee\'s own removal along the Trail of Tears was carried out in 1838-39 under his successor Van Buren — shows that even as Jackson\'s own rhetoric championed "the humble members of society," this era\'s democratic expansion excluded Native nations entirely, a fact beyond anything the bank-veto excerpt itself describes.',
          },
          {
