 ...
 *   institutions.
 * - Doc 3 (Magna Carta) clause 12 is quoted exactly as the Avalon Project
 *   translation preserves it — "No scutage not aid" (an apparent
 *   transcription slip, "not" rather than "nor," left uncorrected).
