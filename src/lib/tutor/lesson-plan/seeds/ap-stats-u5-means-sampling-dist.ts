...
export const SEED_AP_STATS_U5_MEANS_SAMPLING_DIST: LessonPlan = {
  ...
  segments: [
    ...
    { id: 'try-skewed', kind: 'try_yourself',
      ...
      responseFormat: 'free', hints: ['CLT applies for skewed pop with large n.'], estimatedMinutes: 3 },
    { id: 'try-twomeans', kind: 'try_yourself',
      ...
      responseFormat: 'free', hints: ['Variances add; standardize diff.'], estimatedMinutes: 4 },
