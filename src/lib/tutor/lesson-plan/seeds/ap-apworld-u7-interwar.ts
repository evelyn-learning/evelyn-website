  ...
  segments: [
    ...
    },
    {
      ...
      keyIdeas: [
        ...
        'THE MAY FOURTH MOVEMENT (1919, described here) began when Chinese students and intellectuals protested the Paris Peace Conference\'s decision to transfer Germany\'s former concessions in Shandong province to Japan rather than returning them to China — a decision widely seen in China as yet another instance of the great powers disregarding Chinese sovereignty. The protests grew into a broader nationalist and cultural movement critical of both foreign imperialism and China\'s own weak Warsaw-era government.',
