...
export const SEED_AP_STATS_U1_SUMMARY_STATISTICS: LessonPlan = {
  ...
  segments: [
    ...
    { id: 'try-mean-sd', kind: 'try_yourself',
      ...
      responseFormat: 'free', hints: ['SD uses (n−1) in the denominator (sample SD).'], estimatedMinutes: 4 },
    { id: 'try-resistant', kind: 'try_yourself',
      ...
      responseFormat: 'free', hints: ['Compute both before and after; compare change.'], estimatedMinutes: 3 },
