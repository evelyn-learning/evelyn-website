...
export const SEED_AP_APUSH_U3_DBQ_PRACTICE: LessonPlan = {
  ...
  segments: [
    ...
    },
    {
      ...
      expectedAnswer:
        'A full-credit response opens with a thesis arguing that the Revolution transformed American POLITICAL ideals thoroughly (popular sovereignty, government by consent, a written constitution structuring how power is granted and limited) while SOCIAL ideals changed far less completely, or a comparably defensible complex claim with a clear line of reasoning. Contextualization situates the packet in the escalating imperial crisis after the French and Indian War (taxation without representation, the Stamp/Townshend Acts) that first pushed colonists toward the unity Join-or-Die had urged decades earlier. The body groups at least six documents around the thesis rather than summarizing them in order: Paine\'s universal appeal to all who "love mankind" (Doc 1) and the Declaration\'s claim that all men are "created equal" with unalienable rights and that government derives its "just powers from the consent of the governed" (Doc 2) show the Revolution\'s ideals were framed as natural and universal, not merely a colonial grievance; Henry\'s insistence that liberty is worth fighting for (Doc 3) and the earlier Join-or-Die cartoon urging the colonies to unite or perish (Doc 4) show that political unity had to be actively argued for, not assumed; and the post-independence debate over how much power the new government should hold — the Constitution\'s Preamble promising to "form a more perfect Union" and "secure the Blessings of Liberty" (Doc 5), Madison\'s Federalist 10 definition of a faction as citizens "united and actuated by some common impulse of passion, or of interest, adverse to the rights of other citizens" (Doc 6), and Brutus 1\'s warning that no free republic has ever governed so vast a territory without becoming tyrannical (Doc 7) — shows political ideals about popular power were contested and refined for over a decade after 1776, not settled instantly. Outside evidence brings in Shays\' Rebellion (1786-87), whose armed farmer uprising against debt collection under the weak Articles of Confederation directly convinced many leaders a stronger central government was necessary, producing the Constitutional Convention that Documents 5-7 are debating; a strong response can add further outside knowledge of Madison\'s fuller argument in Federalist 10 — that "extending the sphere" over a large republic makes it harder for any single faction to form an oppressive majority — to explain how Federalists answered Brutus\'s fear of a large republic, a point that goes BEYOND the short excerpt in Document 6 and so counts as the student\'s own knowledge, not the document\'s content. Sourcing explains that Brutus 1 (Doc 7) was written by an Anti-Federalist to persuade New York\'s ratifying convention that a distant, powerful federal government threatened the state liberties won by the Revolution, which explains its emphasis on republics failing at scale; that Federalist 10 (Doc 6) was written by Madison, one of the Constitution\'s framers, to persuade the public that his own document deserved ratification, which explains why he defines a faction as citizens acting "adverse to the rights of other citizens" — framing the factional danger as exactly what his proposed government is built to control; and that Join-or-Die (Doc 4) was revived during the 1760s-70s imperial crisis specifically to persuade previously separate, often rival colonies that their survival required unity, explaining its stark either/or visual argument. Complexity is shown by explicitly weighing continuity against change — arguing that while political ideals about legitimate government were reinvented (from monarchy to a constitution ratified through public debate), social ideals about who counted as equal citizens (enslaved Americans, women, Native nations) barely moved in the same period — rather than treating "change" as a single uniform verdict.',
      rubric: {
        parts: [
          {
          ...
          },
          {
            ...
            modelResponse:
              'Paine\'s appeal to all who "love mankind" (Doc 1) and the Declaration\'s claim that all men are "created equal" with government deriving "just powers from the consent of the governed" (Doc 2) frame the Revolution\'s political ideals as universal natural rights, not a narrow colonial complaint. Henry\'s call to fight for liberty (Doc 3) and the earlier Join-or-Die cartoon (Doc 4) show that political unity itself had to be argued for. The post-1776 documents then show the argument continuing: the Constitution\'s Preamble promises to "secure the Blessings of Liberty" through a "more perfect Union" (Doc 5), Federalist 10 defines a faction as citizens whose common interest is "adverse to the rights of other citizens" (Doc 6) — naming the danger of majority tyranny the new government was meant to check — and Brutus 1 warns that free republics have never governed so vast a territory (Doc 7), together showing political ideals about how much popular power a government could safely hold remained contested for over a decade after independence.',
          },
          {
            ...
            modelResponse:
              'Shays\' Rebellion (1786-87), an armed uprising of indebted Massachusetts farmers against the state\'s enforcement of debt collection, showed that the weak central government under the Articles of Confederation could not reliably keep order or address economic grievances — a failure that directly convinced many political leaders a stronger federal government was necessary, producing the Constitutional Convention that Documents 5 through 7 are arguing over. A response could alternatively supply, from its own knowledge, Madison\'s fuller argument in Federalist 10 that "extending the sphere" across a large republic prevents any single faction from forming an oppressive majority — outside evidence beyond the packet, since Document 6 provides only Madison\'s definition of a faction and not this large-republic remedy, and one that directly rebuts Brutus 1\'s fear that a large republic must fail.',
          },
          {
            ...
            modelResponse:
              'Brutus 1 (Doc 7) was written by an Anti-Federalist aiming to persuade New York\'s ratifying convention that a powerful distant government threatened the state liberties the Revolution had just won, which explains its focus on free republics failing at large scale. Federalist 10 (Doc 6) was written by James Madison, one of the Constitution\'s own framers, to build public support for ratifying the document he helped draft, which explains why he defines a faction as a group whose interest is "adverse to the rights of other citizens" — casting the factional danger as precisely the threat his proposed government is designed to control. Join-or-Die (Doc 4), though first published in 1754, was deliberately revived during the 1760s-70s imperial crisis to persuade previously separate, often rival colonies that only unity could ensure their survival, explaining its stark visual either/or argument.',
          },
          {
