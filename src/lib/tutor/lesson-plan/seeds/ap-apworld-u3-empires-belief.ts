  ...
  segments: [
    ...
    },
    {
      ...
      steps: [
        ...
        "CONTRAST WITH THE UNIT'S PLURALISM THEME. The Taj Mahal asserts legitimacy specifically through SUNNI Islamic imagery and patronage under Shah Jahan — a narrower, more explicitly religious statement than his great-grandfather Akbar's sulh-i-kul, and a preview of the further narrowing under Aurangzeb's reimposition of the jizya. It's a reminder that legitimation strategies could tilt toward one faith's display even in an empire ruling a religiously diverse population.",
