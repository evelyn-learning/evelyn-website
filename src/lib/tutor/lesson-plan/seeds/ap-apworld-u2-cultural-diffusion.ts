  ...
  segments: [
    ...
    },
    {
      ...
      keyIdeas: [
        ...
        "NEO-CONFUCIANISM diffused within East Asia in this same era: a revival and reworking of classical Confucian thought (blending it with Buddhist and Daoist ideas) that flourished in Song China and then spread to Korea, Japan, and Vietnam as those societies adopted Chinese-style bureaucratic governance and the civil-service examination culture built on Confucian texts — a case of an intellectual/political tradition diffusing outward from a dominant cultural center along the same channels of contact.",
    ...
    },
    {
      ...
      mustRemember: [
        ...
        'Islam spread across the Sahel and Indian Ocean world, Buddhism earlier spread along the Silk Roads, and Neo-Confucianism diffused from Song China to Korea, Japan, and Vietnam — all carried by the same networks of trade and contact.',
