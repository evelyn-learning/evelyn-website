  ...
  segments: [
    ...
    },
    {
      ...
      keyIdeas: [
        ...
        "NEO-CONFUCIANISM diffused within East Asia in this same era: a revival and reworking of classical Confucian thought (blending it with Buddhist and Daoist ideas) that flourished in Song China and then spread to Korea, Japan, and Vietnam — but ADOPTION VARIED. Korea and Vietnam went furthest, adopting Chinese-style bureaucratic governance and the civil-service examination culture built on Confucian texts. Japan, by contrast, absorbed Neo-Confucian thought and culture WITHOUT the examination system: Kamakura- and Ashikaga-era Japan (1200-1450) remained governed by hereditary, military (samurai) rule, not an exam-based bureaucracy — a reminder that diffusion of an idea does not automatically mean adoption of the political system built on it.",
    ...
    },
    {
      ...
      mustRemember: [
        ...
        'Islam spread across the Sahel and Indian Ocean world, Buddhism earlier spread along the Silk Roads, and Neo-Confucian thought diffused from Song China to Korea, Japan, and Vietnam — though only Korea and Vietnam adopted the Confucian civil-service exam system; Japan absorbed the thought without the exams, keeping hereditary, military (samurai) rule.',
