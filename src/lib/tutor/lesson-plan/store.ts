...
import { SEED_AP_STATS_U8_GOODNESS_OF_FIT } from './seeds/ap-stats-u8-goodness-of-fit';
...
import { SEED_AP_APUSH_U2_COLONIAL_REGIONS } from './seeds/ap-apush-u2-colonial-regions';
...
import { SEED_AP_APUSH_U5_DBQ_PRACTICE } from './seeds/ap-apush-u5-dbq-practice';
import { SEED_AP_APUSH_U5_LEQ_PRACTICE } from './seeds/ap-apush-u5-leq-practice';
import { SEED_AP_APUSH_U5_SAQ_PRACTICE } from './seeds/ap-apush-u5-saq-practice';
// AP US History — Period-6 fan-out (1865-1898).
import { SEED_AP_APUSH_U6_THE_WEST } from './seeds/ap-apush-u6-the-west';
import { SEED_AP_APUSH_U6_INDUSTRIALIZATION } from './seeds/ap-apush-u6-industrialization';
...
import { SEED_AP_APGOV_U3_RELIGION_SPEECH } from './seeds/ap-apgov-u3-religion-speech';
...
import { SEED_AP_APGOV_U4_SOCIALIZATION } from './seeds/ap-apgov-u4-socialization';
import { SEED_AP_APGOV_U4_POLLING } from './seeds/ap-apgov-u4-polling';
import { SEED_AP_APGOV_U4_IDEOLOGY_POLICY } from './seeds/ap-apgov-u4-ideology-policy';
import { SEED_AP_APGOV_U4_FRQ_CONCEPT_APPLICATION } from './seeds/ap-apgov-u4-frq-concept-application';
import { SEED_AP_APGOV_U4_FRQ_QUANTITATIVE } from './seeds/ap-apgov-u4-frq-quantitative';
import { SEED_AP_APGOV_U4_FRQ_SCOTUS_COMPARISON } from './seeds/ap-apgov-u4-frq-scotus-comparison';
import { SEED_AP_APGOV_U4_FRQ_ARGUMENT_ESSAY } from './seeds/ap-apgov-u4-frq-argument-essay';
import { SEED_AP_APGOV_U5_VOTING } from './seeds/ap-apgov-u5-voting';
import { SEED_AP_APGOV_U5_PARTIES } from './seeds/ap-apgov-u5-parties';
import { SEED_AP_APGOV_U5_INTEREST_GROUPS } from './seeds/ap-apgov-u5-interest-groups';
import { SEED_AP_APGOV_U5_ELECTIONS } from './seeds/ap-apgov-u5-elections';
import { SEED_AP_APGOV_U5_MEDIA } from './seeds/ap-apgov-u5-media';
import { SEED_AP_APGOV_U5_FRQ_CONCEPT_APPLICATION } from './seeds/ap-apgov-u5-frq-concept-application';
import { SEED_AP_APGOV_U5_FRQ_QUANTITATIVE } from './seeds/ap-apgov-u5-frq-quantitative';
import { SEED_AP_APGOV_U5_FRQ_SCOTUS_COMPARISON } from './seeds/ap-apgov-u5-frq-scotus-comparison';
import { SEED_AP_APGOV_U5_FRQ_ARGUMENT_ESSAY } from './seeds/ap-apgov-u5-frq-argument-essay';
...
import { SEED_TEST_G5_COMPARISON_TABLE } from './seeds/test-g5-comparison-table';
...
export const SEED_PLANS: LessonPlan[] = [
  ...
  SEED_AP_STATS_U8_GOODNESS_OF_FIT,
  ...
  // AP US History — Period-2 fan-out content plans.
  SEED_AP_APUSH_U2_COLONIAL_REGIONS,
  ...
  SEED_AP_APUSH_U5_DBQ_PRACTICE,
  SEED_AP_APUSH_U5_LEQ_PRACTICE,
  SEED_AP_APUSH_U5_SAQ_PRACTICE,
  // AP US History — Period-6 fan-out content plans.
  SEED_AP_APUSH_U6_THE_WEST,
  SEED_AP_APUSH_U6_INDUSTRIALIZATION,
  ...
  SEED_AP_APGOV_U3_RELIGION_SPEECH,
  ...
  SEED_AP_APGOV_U4_SOCIALIZATION,
  SEED_AP_APGOV_U4_POLLING,
  SEED_AP_APGOV_U4_IDEOLOGY_POLICY,
  SEED_AP_APGOV_U4_FRQ_CONCEPT_APPLICATION,
  SEED_AP_APGOV_U4_FRQ_QUANTITATIVE,
  SEED_AP_APGOV_U4_FRQ_SCOTUS_COMPARISON,
  SEED_AP_APGOV_U4_FRQ_ARGUMENT_ESSAY,
  SEED_AP_APGOV_U5_VOTING,
  SEED_AP_APGOV_U5_PARTIES,
  SEED_AP_APGOV_U5_INTEREST_GROUPS,
  SEED_AP_APGOV_U5_ELECTIONS,
  SEED_AP_APGOV_U5_MEDIA,
  SEED_AP_APGOV_U5_FRQ_CONCEPT_APPLICATION,
  SEED_AP_APGOV_U5_FRQ_QUANTITATIVE,
  SEED_AP_APGOV_U5_FRQ_SCOTUS_COMPARISON,
  SEED_AP_APGOV_U5_FRQ_ARGUMENT_ESSAY,
...
export const TOPIC_ALIASES: Record<string, string[]> = {
  ...
  'ap-environmental': ['ap-environmental', 'ap-environmental-science', 'environmental-science'],
