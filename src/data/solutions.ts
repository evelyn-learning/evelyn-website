...
export const SOLUTION_SEGMENTS: SolutionSegment[] = [
  {
    ...
    demoLessons: [
      ...
      {
        planId: "evelyn.testprep.nclex.strategy.v1",
        title: "NCLEX Prioritization Strategy",
        subjectLabel: "Nursing",
        levelLabel: "NCLEX",
        hook: "Frameworks for prioritizing patient care under exam pressure",
      },
    ],
    demoSubject: "Nursing",
    demoLevel: "NCLEX",
  ...
  },
  {
    ...
    demoLessons: [
      {
        planId: "evelyn.college.intro-economics.v1",
        title: "Intro Economics: Micro + Macro Foundations",
        subjectLabel: "Economics",
        levelLabel: "College-level",
        hook: "The foundational concepts behind business decision-making",
      },
      {
        planId: "evelyn.college.cs101.v1",
