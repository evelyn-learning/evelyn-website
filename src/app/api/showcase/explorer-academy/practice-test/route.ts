...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const response = await anthropic.messages.create({
      ...
      max_tokens: 3000,
      system: `You are an expert test creator for the British Columbia (Canada) K-10 curriculum. Generate practice test questions that are curriculum-aligned, age-appropriate, and pedagogically sound.
  ...
  "questions": [
    {
      ...
      "correctIndex": 0,
      "explanation": "Brief explanation of why this is the correct answer and what concept it tests",
