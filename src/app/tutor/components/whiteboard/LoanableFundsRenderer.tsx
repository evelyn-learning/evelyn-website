...
import type { LoanableFundsFigure } from '@/lib/tutor/diagrams/catalog/kinds/economics';
...
export function LoanableFundsRenderer({ figure }: { figure: LoanableFundsFigure }) {
  ...
  return (
    <div className="loanable-funds-renderer w-full flex flex-col items-center">
