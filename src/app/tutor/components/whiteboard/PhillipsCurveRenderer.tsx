...
import type { PhillipsCurveFigure } from '@/lib/tutor/diagrams/catalog/kinds/economics';
...
export function PhillipsCurveRenderer({ figure }: { figure: PhillipsCurveFigure }) {
  ...
  return (
    <div className="phillips-curve-renderer w-full flex flex-col items-center">
