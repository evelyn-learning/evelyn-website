...
const productId = 'curriculum-designer';
const productName = 'AI Curriculum Designer';
const productDescription = 'Generate standards-aligned curriculum maps, lesson plans, and learning objectives in minutes instead of weeks. Built for educators with support for 50+ standards frameworks.';
