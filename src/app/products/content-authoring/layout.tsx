...
const productId = 'content-authoring';
const productName = 'Content Authoring AI';
const productDescription = 'Transform any text into quizzes, flashcards, and study materials instantly. AI-powered content generation that saves 90% of development time with multiple output formats.';
