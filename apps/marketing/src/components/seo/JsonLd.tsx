...
// EducationalOrganizationJsonLd and WebSiteJsonLd (the root-layout schema)
// moved to packages/core — both apps' root layouts render them. Re-exported
// here so any other existing import of them from this file keeps resolving.
export { EducationalOrganizationJsonLd, WebSiteJsonLd } from "@core/components/seo/JsonLd";
