  ...
  segments: [
    ...
    },
    {
      ...
      keyIdeas: [
        ...
        "THE COMMERCE COMPROMISE: Congress was granted power to regulate interstate and foreign commerce (fixing an Articles weakness), but was PERMANENTLY barred from taxing exports (Art. I, §9) — a restriction still in force today. Separately, as a concession to Southern states, Congress was prohibited from banning the international slave trade until 1808 (a time-limited protection that did expire). Both restrictions helped protect slavery's economic base and secure Southern support for the stronger national government, but only the slave-trade clause carried the twenty-year sunset.",
