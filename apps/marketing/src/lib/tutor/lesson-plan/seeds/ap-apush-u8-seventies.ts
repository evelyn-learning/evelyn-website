...
export const SEED_AP_APUSH_U8_SEVENTIES: LessonPlan = {
  ...
  segments: [
    ...
    },
    {
      ...
      kind: 'worked_example',
      problem:
        'Nixon signed the SALT I arms-control treaty with the Soviet Union in 1972 and opened relations with Communist China the same year — both often described as "easing" Cold War tensions. At the very same time, the United States continued fighting an active war against a Communist government in Vietnam, and Nixon significantly expanded US military spending and covert Cold War operations elsewhere in the world. How can BOTH of these be accurate descriptions of Nixon-era foreign policy, and what does that combination reveal about what "détente" actually meant?',
      steps: [
