...
const productId = 'test-generator';
const productName = 'AI Practice Test Generator';
const productDescription = 'Generate unlimited unique practice tests with AI. Standards-aligned questions for SAT, ACT, AP, and custom curricula with detailed explanations. Eliminate answer memorization with fresh content every time.';
  ...
  return (
    <>
      <SoftwareApplicationJsonLd
        ...
        featureList={[
          'Unlimited unique question generation',
          'Multiple test type support (SAT, ACT, AP)',
          'Difficulty calibration',
          'Topic-specific targeting',
          'Detailed answer explanations',
          'LMS and API integration',
        ]}
      />
