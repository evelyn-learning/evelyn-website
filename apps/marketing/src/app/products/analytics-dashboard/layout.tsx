...
const productId = 'analytics-dashboard';
const productName = 'Student Analytics Dashboard';
const productDescription = 'Real-time insights into student progress, engagement, and learning patterns. Identify at-risk students early and make data-driven instructional decisions with comprehensive analytics.';
