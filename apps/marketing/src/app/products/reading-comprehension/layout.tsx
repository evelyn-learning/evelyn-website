...
const productId = 'reading-comprehension';
const productName = 'Reading Comprehension AI';
const productDescription = 'Analyze any passage to generate reading level assessments, vocabulary lists, and multi-level comprehension questions automatically. Complete reading analysis toolkit for K-12 and beyond.';
    ...
    <>
      <SoftwareApplicationJsonLd
        ...
        featureList={[
          ...
          'Multi-level comprehension questions',
          'Vocabulary extraction',
          'Text structure analysis',
          'Theme identification',
          'Differentiated materials generation',
        ]}
      />
