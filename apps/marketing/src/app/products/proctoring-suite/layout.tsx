...
const productId = 'proctoring-suite';
const productName = 'AI Proctoring Suite';
const productDescription = 'Enterprise-grade exam proctoring with AI-powered face detection, browser lockdown, and real-time anomaly detection. FERPA-compliant with human review workflows for remote assessment integrity.';
