 ...
 * ellipses to stay within excerpt length (including a leading ellipsis on
 * Article XIII to mark that its opening clause was cut); substantively
 * verbatim public-domain text otherwise (capitalization and spelling
 * lightly modernized, e.g. lowercased "state"/"congress"), verified
 * against the National Archives transcript.
 */
