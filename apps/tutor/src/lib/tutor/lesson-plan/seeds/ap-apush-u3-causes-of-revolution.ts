  ...
  segments: [
    ...
    },
    {
      ...
      keyIdeas: [
        ...
        "NEW TAXES, NEW ANGER: after 1763 Parliament imposed a sequence of revenue measures. The Sugar Act (1764) and Townshend Acts (1767) were EXTERNAL duties on imported goods; the Stamp Act (1765) was a DIRECT INTERNAL tax on printed materials — the kind colonists most fiercely rejected as 'taxation without representation.' The Tea Act (1773) added NO new tax: it kept the existing Townshend tea duty but granted the East India Company a monopoly on direct tea sales, undercutting colonial merchants and smugglers and provoking the Boston Tea Party. The through-line colonists objected to: Parliament, in which they had no representatives, taxing them for revenue rather than merely regulating trade — a break from the self-taxation they had run through their own assemblies.",
