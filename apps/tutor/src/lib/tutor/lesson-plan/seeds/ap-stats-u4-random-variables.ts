...
export const SEED_AP_STATS_U4_RANDOM_VARIABLES: LessonPlan = {
  ...
  segments: [
    ...
    { id: 'try-distribution', kind: 'try_yourself',
      ...
      responseFormat: 'free', hints: ['Multiply each value by its probability and sum.'], estimatedMinutes: 2 },
    { id: 'try-sd', kind: 'try_yourself',
      ...
      responseFormat: 'free', hints: ['Mean first; then squared deviations weighted by probabilities.'], estimatedMinutes: 4 },
