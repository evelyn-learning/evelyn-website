...
export const SEED_AP_STATS_U2_LINEAR_REGRESSION: LessonPlan = {
  ...
  segments: [
    ...
    { id: 'try-slope-intercept', kind: 'try_yourself',
      ...
      responseFormat: 'free', hints: ['Slope sign, intercept meaning, plug-in.'], estimatedMinutes: 3 },
    { id: 'try-extrapolation', kind: 'try_yourself',
      ...
      responseFormat: 'free', hints: ['Check whether x is in the observed range.'], estimatedMinutes: 3 },
