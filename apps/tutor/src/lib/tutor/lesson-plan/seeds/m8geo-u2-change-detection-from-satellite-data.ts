  ...
  segments: [
    ...
    },
    {
      ...
      keyIdeas: [
        ...
        'NET CHANGE HIDES GROSS CHANGE. The figure a subtraction gives you is the NET change: everything a class gained and everything it lost, already cancelled against each other. A class can lose 400 hectares on one side and gain 400 on the other and come out at zero, and the table will show it standing perfectly still while 800 hectares of ground changed hands. So "no change in this class" is never a safe reading of a zero. It means the gains and the losses matched, which is a fact about the arithmetic and not a fact about the ground.',
      ...
      vocabulary: [
        ...
        },
        {
          term: 'net change',
          definition:
            'a class figure at the second date minus its figure at the first, so that hectares gained and hectares lost have already cancelled each other out.',
        },
        {
          term: 'gross change',
          definition:
            'the hectares that entered a class and the hectares that left it, counted as two separate figures instead of cancelled into one.',
        },
        {
          term: 'resolution',
          definition:
