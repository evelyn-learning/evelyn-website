  ...
  segments: [
    {
      ...
      script:
        'You are working the snack stand at the school carnival. The slushie comes in a tall round cup, the snow cone comes in a paper cone, and the prize for the free-throw contest is a basketball. Your manager wants to know how much each one holds, because she orders syrup by the liter and she does not want to run out at 2 p.m. Last year you found the volume of a box with V = Bh: the area of the base, stacked up h times. A slushie cup is a stack too, except the base is a circle, and you already know that a circle has area πr². So the cup is not a new problem at all. The cone and the ball need two formulas you have not met yet, but both of them are built out of the cup, and once you see how, you will never mix them up.',
