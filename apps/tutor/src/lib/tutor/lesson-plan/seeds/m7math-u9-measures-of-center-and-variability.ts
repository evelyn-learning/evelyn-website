  ...
  segments: [
    ...
    },
    {
      ...
      keyIdeas: [
        ...
        'THE MODE IS THE REPEATER — the value that appears most often. A data set can have one mode, several modes, or none at all. Mode is useful for things you cannot average, such as favourite colour, but it is a weak description of center for numbers.',
