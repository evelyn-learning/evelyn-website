  ...
  segments: [
    {
      ...
      script:
        'Your friend sits down at lunch, and before you have finished opening your drink she says, "I\'m not going to tryouts." Everything shifts. You had planned to walk over together, so now you are going alone or not at all, and the whole after-school arrangement the two of you built depends on her being there. The sentence also told you something about her, because she said it before you asked, and she said it flat, like a fact she had already argued about with herself. One line, and two things happened: the afternoon changed shape, and you learned something. Now compare that with "Pass the ketchup." A story is full of both kinds of line. Writers put dialogue on the page because a line can do a job that narration cannot do as quickly: it can change what happens next and show you who someone is in the same breath. You already know how to read what a character says as a clue to what they are like. Today the question is bigger. What did this line DO? What happens after it that would not have happened without it, and what does the way it was said show about the person who said it, or the person who heard it?',
      estimatedMinutes: 1,
    },
    {
