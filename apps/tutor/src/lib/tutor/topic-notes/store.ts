...
import { BASELINE_M8MATH_U1_ESTIMATING_AND_LOCATING_IRRATIONAL_NUMBERS } from './seeds/m8math-u1-estimating-and-locating-irrational-numbers';
import { BASELINE_M8MATH_U1_RATIONAL_AND_IRRATIONAL_NUMBERS } from './seeds/m8math-u1-rational-and-irrational-numbers';
import { BASELINE_M8MATH_U1_REPEATING_DECIMALS_TO_FRACTIONS } from './seeds/m8math-u1-repeating-decimals-to-fractions';
import { BASELINE_M8MATH_U1_SQUARE_ROOTS_AND_CUBE_ROOTS } from './seeds/m8math-u1-square-roots-and-cube-roots';
import { BASELINE_M8MATH_U2_OPERATIONS_IN_SCIENTIFIC_NOTATION } from './seeds/m8math-u2-operations-in-scientific-notation';
import { BASELINE_M8MATH_U2_PRODUCT_QUOTIENT_AND_POWER_OF_A_POWER_RULES } from './seeds/m8math-u2-product-quotient-and-power-of-a-power-rules';
import { BASELINE_M8MATH_U2_SCIENTIFIC_NOTATION } from './seeds/m8math-u2-scientific-notation';
import { BASELINE_M8MATH_U2_ZERO_AND_NEGATIVE_EXPONENTS } from './seeds/m8math-u2-zero-and-negative-exponents';
import { BASELINE_M8MATH_U3_COMPARING_PROPORTIONAL_RELATIONSHIPS } from './seeds/m8math-u3-comparing-proportional-relationships';
import { BASELINE_M8MATH_U3_DERIVING_Y_EQUALS_MX_PLUS_B } from './seeds/m8math-u3-deriving-y-equals-mx-plus-b';
import { BASELINE_M8MATH_U3_SLOPE_FROM_SIMILAR_TRIANGLES } from './seeds/m8math-u3-slope-from-similar-triangles';
import { BASELINE_M8MATH_U3_UNIT_RATE_AS_SLOPE } from './seeds/m8math-u3-unit-rate-as-slope';
import { BASELINE_M8MATH_U4_EQUATIONS_WITH_DISTRIBUTION_AND_LIKE_TERMS } from './seeds/m8math-u4-equations-with-distribution-and-like-terms';
import { BASELINE_M8MATH_U4_EQUATIONS_WITH_RATIONAL_COEFFICIENTS } from './seeds/m8math-u4-equations-with-rational-coefficients';
import { BASELINE_M8MATH_U4_EQUATIONS_WITH_VARIABLES_ON_BOTH_SIDES } from './seeds/m8math-u4-equations-with-variables-on-both-sides';
import { BASELINE_M8MATH_U4_ONE_NONE_OR_INFINITELY_MANY_SOLUTIONS } from './seeds/m8math-u4-one-none-or-infinitely-many-solutions';
import { BASELINE_M8MATH_U5_SOLUTIONS_OF_SYSTEMS_AS_INTERSECTION_POINTS } from './seeds/m8math-u5-solutions-of-systems-as-intersection-points';
import { BASELINE_M8MATH_U5_SOLVING_SYSTEMS_BY_GRAPHING } from './seeds/m8math-u5-solving-systems-by-graphing';
import { BASELINE_M8MATH_U5_SOLVING_SYSTEMS_BY_SUBSTITUTION } from './seeds/m8math-u5-solving-systems-by-substitution';
import { BASELINE_M8MATH_U5_SYSTEMS_WORD_PROBLEMS } from './seeds/m8math-u5-systems-word-problems';
import { BASELINE_M8MATH_U6_COMPARING_FUNCTIONS_IN_DIFFERENT_REPRESENTATIONS } from './seeds/m8math-u6-comparing-functions-in-different-representations';
import { BASELINE_M8MATH_U6_IDENTIFYING_FUNCTIONS } from './seeds/m8math-u6-identifying-functions';
import { BASELINE_M8MATH_U6_LINEAR_VS_NONLINEAR_FUNCTIONS } from './seeds/m8math-u6-linear-vs-nonlinear-functions';
import { BASELINE_M8MATH_U6_VOLUME_OF_CYLINDERS_CONES_AND_SPHERES } from './seeds/m8math-u6-volume-of-cylinders-cones-and-spheres';
import { BASELINE_M8MATH_U7_CONSTRUCTING_LINEAR_MODELS_FROM_DESCRIPTIONS } from './seeds/m8math-u7-constructing-linear-models-from-descriptions';
import { BASELINE_M8MATH_U7_DESCRIBING_AND_SKETCHING_QUALITATIVE_GRAPHS } from './seeds/m8math-u7-describing-and-sketching-qualitative-graphs';
import { BASELINE_M8MATH_U7_INTERPRETING_AND_USING_LINEAR_MODELS } from './seeds/m8math-u7-interpreting-and-using-linear-models';
import { BASELINE_M8MATH_U7_RATE_OF_CHANGE_AND_INITIAL_VALUE_FROM_TABLES_AND_GRAPHS } from './seeds/m8math-u7-rate-of-change-and-initial-value-from-tables-and-graphs';
import { BASELINE_M8MATH_U8_CONGRUENCE_THROUGH_RIGID_MOTIONS } from './seeds/m8math-u8-congruence-through-rigid-motions';
import { BASELINE_M8MATH_U8_DILATIONS_AND_SIMILARITY } from './seeds/m8math-u8-dilations-and-similarity';
import { BASELINE_M8MATH_U8_ROTATIONS_ABOUT_THE_ORIGIN } from './seeds/m8math-u8-rotations-about-the-origin';
import { BASELINE_M8MATH_U8_TRANSLATIONS_AND_REFLECTIONS } from './seeds/m8math-u8-translations-and-reflections';
import { BASELINE_M8MATH_U9_PARALLEL_LINES_CUT_BY_A_TRANSVERSAL } from './seeds/m8math-u9-parallel-lines-cut-by-a-transversal';
import { BASELINE_M8MATH_U9_PYTHAGOREAN_APPLICATIONS_AND_DISTANCE_BETWEEN_POINTS } from './seeds/m8math-u9-pythagorean-applications-and-distance-between-points';
import { BASELINE_M8MATH_U9_THE_PYTHAGOREAN_THEOREM_AND_ITS_CONVERSE } from './seeds/m8math-u9-the-pythagorean-theorem-and-its-converse';
import { BASELINE_M8MATH_U9_TRIANGLE_ANGLE_SUM_EXTERIOR_ANGLES_AND_AA_SIMILARITY } from './seeds/m8math-u9-triangle-angle-sum-exterior-angles-and-aa-similarity';
import { BASELINE_M8MATH_U10_FITTING_A_LINE_TO_A_SCATTER_PLOT } from './seeds/m8math-u10-fitting-a-line-to-a-scatter-plot';
import { BASELINE_M8MATH_U10_SCATTER_PLOTS_AND_ASSOCIATION } from './seeds/m8math-u10-scatter-plots-and-association';
import { BASELINE_M8MATH_U10_TWO_WAY_TABLES_AND_RELATIVE_FREQUENCIES } from './seeds/m8math-u10-two-way-tables-and-relative-frequencies';
import { BASELINE_M8MATH_U10_USING_A_LINEAR_MODEL_WITH_BIVARIATE_DATA } from './seeds/m8math-u10-using-a-linear-model-with-bivariate-data';
import { BASELINE_M8ELA_U1_COMPARING_THE_STRUCTURE_OF_TWO_TEXTS } from './seeds/m8ela-u1-comparing-the-structure-of-two-texts';
import { BASELINE_M8ELA_U1_HOW_AN_INCIDENT_PROVOKES_A_DECISION } from './seeds/m8ela-u1-how-an-incident-provokes-a-decision';
import { BASELINE_M8ELA_U1_HOW_DIALOGUE_PROPELS_ACTION_AND_REVEALS_CHARACTER } from './seeds/m8ela-u1-how-dialogue-propels-action-and-reveals-character';
import { BASELINE_M8ELA_U1_STRONGEST_TEXTUAL_EVIDENCE } from './seeds/m8ela-u1-strongest-textual-evidence';
import { BASELINE_M8ELA_U2_ALLUSIONS_AND_ANALOGIES_IN_LITERATURE } from './seeds/m8ela-u2-allusions-and-analogies-in-literature';
import { BASELINE_M8ELA_U2_DRAMATIC_IRONY_SUSPENSE_AND_HUMOR } from './seeds/m8ela-u2-dramatic-irony-suspense-and-humor';
import { BASELINE_M8ELA_U2_HOW_A_THEME_DEVELOPS_THROUGH_CHARACTER_AND_SETTING } from './seeds/m8ela-u2-how-a-theme-develops-through-character-and-setting';
import { BASELINE_M8ELA_U2_MODERN_STORIES_AND_TRADITIONAL_PATTERNS } from './seeds/m8ela-u2-modern-stories-and-traditional-patterns';
import { BASELINE_M8ELA_U3_CONNECTIONS_AND_DISTINCTIONS_AMONG_IDEAS } from './seeds/m8ela-u3-connections-and-distinctions-among-ideas';
import { BASELINE_M8ELA_U3_HOW_A_CENTRAL_IDEA_DEVELOPS } from './seeds/m8ela-u3-how-a-central-idea-develops';
import { BASELINE_M8ELA_U3_THE_ROLE_OF_A_SENTENCE_IN_A_PARAGRAPH } from './seeds/m8ela-u3-the-role-of-a-sentence-in-a-paragraph';
import { BASELINE_M8ELA_U3_WORD_CHOICE_AND_ANALOGY_IN_INFORMATIONAL_TEXT } from './seeds/m8ela-u3-word-choice-and-analogy-in-informational-text';
import { BASELINE_M8ELA_U4_CHOOSING_THE_MEDIUM_FOR_AN_IDEA } from './seeds/m8ela-u4-choosing-the-medium-for-an-idea';
import { BASELINE_M8ELA_U4_HOW_AN_AUTHOR_RESPONDS_TO_OPPOSING_VIEWS } from './seeds/m8ela-u4-how-an-author-responds-to-opposing-views';
import { BASELINE_M8ELA_U4_IS_THE_REASONING_SOUND } from './seeds/m8ela-u4-is-the-reasoning-sound';
import { BASELINE_M8ELA_U4_WHERE_TWO_TEXTS_DISAGREE_FACT_OR_INTERPRETATION } from './seeds/m8ela-u4-where-two-texts-disagree-fact-or-interpretation';
import { BASELINE_M8ELA_U5_ACTIVE_AND_PASSIVE_VOICE } from './seeds/m8ela-u5-active-and-passive-voice';
import { BASELINE_M8ELA_U5_GERUNDS_AND_PARTICIPLES } from './seeds/m8ela-u5-gerunds-and-participles';
import { BASELINE_M8ELA_U5_INFINITIVES_AND_VERBAL_PHRASES } from './seeds/m8ela-u5-infinitives-and-verbal-phrases';
import { BASELINE_M8ELA_U5_VERB_MOODS } from './seeds/m8ela-u5-verb-moods';
import { BASELINE_M8ELA_U6_DASHES_AND_COMMAS_FOR_A_BREAK } from './seeds/m8ela-u6-dashes-and-commas-for-a-break';
import { BASELINE_M8ELA_U6_ELLIPSIS_FOR_A_PAUSE_OR_AN_OMISSION } from './seeds/m8ela-u6-ellipsis-for-a-pause-or-an-omission';
import { BASELINE_M8ELA_U6_SHIFTS_IN_VOICE_AND_MOOD } from './seeds/m8ela-u6-shifts-in-voice-and-mood';
import { BASELINE_M8ELA_U6_VOICE_AND_MOOD_FOR_EFFECT } from './seeds/m8ela-u6-voice-and-mood-for-effect';
import { BASELINE_M8ELA_U7_SHADES_OF_MEANING_DEGREE_AND_FORMALITY } from './seeds/m8ela-u7-shades-of-meaning-degree-and-formality';
import { BASELINE_M8ELA_U7_VERBAL_IRONY_AND_PUNS } from './seeds/m8ela-u7-verbal-irony-and-puns';
import { BASELINE_M8ELA_U7_VERIFYING_WORD_MEANING_WITH_CONTEXT_AND_A_DICTIONARY } from './seeds/m8ela-u7-verifying-word-meaning-with-context-and-a-dictionary';
import { BASELINE_M8ELA_U7_WORD_FAMILIES_FROM_A_SHARED_ROOT } from './seeds/m8ela-u7-word-families-from-a-shared-root';
import { BASELINE_M8ELA_U8_A_CLAIM_THAT_ANSWERS_THE_OPPOSING_CLAIM } from './seeds/m8ela-u8-a-claim-that-answers-the-opposing-claim';
import { BASELINE_M8ELA_U8_COHESION_AMONG_CLAIM_COUNTERCLAIM_AND_EVIDENCE } from './seeds/m8ela-u8-cohesion-among-claim-counterclaim-and-evidence';
import { BASELINE_M8ELA_U8_FORMAL_STYLE_IN_ARGUMENT } from './seeds/m8ela-u8-formal-style-in-argument';
import { BASELINE_M8ELA_U8_REBUTTING_WITH_EVIDENCE_FROM_CREDIBLE_SOURCES } from './seeds/m8ela-u8-rebutting-with-evidence-from-credible-sources';
import { BASELINE_M8ELA_U9_ESTABLISHING_POINT_OF_VIEW_AND_SHIFTING_TIME_IN_A_NARRATIVE } from './seeds/m8ela-u9-establishing-point-of-view-and-shifting-time-in-a-narrative';
import { BASELINE_M8ELA_U9_ORGANIZING_INFORMATION_INTO_BROADER_CATEGORIES } from './seeds/m8ela-u9-organizing-information-into-broader-categories';
import { BASELINE_M8ELA_U9_PRECISE_LANGUAGE_AND_DOMAIN_VOCABULARY } from './seeds/m8ela-u9-precise-language-and-domain-vocabulary';
import { BASELINE_M8ELA_U9_REFLECTION_AND_A_NARRATIVE_CONCLUSION } from './seeds/m8ela-u9-reflection-and-a-narrative-conclusion';
import { BASELINE_M8ELA_U10_BLENDING_A_QUOTATION_INTO_YOUR_OWN_SENTENCE } from './seeds/m8ela-u10-blending-a-quotation-into-your-own-sentence';
import { BASELINE_M8ELA_U10_FOLLOWING_A_STANDARD_CITATION_FORMAT } from './seeds/m8ela-u10-following-a-standard-citation-format';
import { BASELINE_M8ELA_U10_GENERATING_RELATED_RESEARCH_QUESTIONS } from './seeds/m8ela-u10-generating-related-research-questions';
import { BASELINE_M8ELA_U10_USING_SEARCH_TERMS_EFFECTIVELY } from './seeds/m8ela-u10-using-search-terms-effectively';
import { BASELINE_M8SCI_U1_FORCES_AND_NET_FORCE } from './seeds/m8sci-u1-forces-and-net-force';
import { BASELINE_M8SCI_U1_MOTION_REFERENCE_POINTS_AND_SPEED } from './seeds/m8sci-u1-motion-reference-points-and-speed';
import { BASELINE_M8SCI_U1_READING_DISTANCE_TIME_GRAPHS } from './seeds/m8sci-u1-reading-distance-time-graphs';
import { BASELINE_M8SCI_U1_VELOCITY_AND_ACCELERATION } from './seeds/m8sci-u1-velocity-and-acceleration';
import { BASELINE_M8SCI_U2_COLLISIONS_AND_DESIGNING_FOR_SAFETY } from './seeds/m8sci-u2-collisions-and-designing-for-safety';
import { BASELINE_M8SCI_U2_NEWTONS_FIRST_LAW_INERTIA_AND_FRICTION } from './seeds/m8sci-u2-newtons-first-law-inertia-and-friction';
import { BASELINE_M8SCI_U2_NEWTONS_SECOND_LAW_FORCE_MASS_AND_ACCELERATION } from './seeds/m8sci-u2-newtons-second-law-force-mass-and-acceleration';
import { BASELINE_M8SCI_U2_NEWTONS_THIRD_LAW_ACTION_REACTION_PAIRS } from './seeds/m8sci-u2-newtons-third-law-action-reaction-pairs';
import { BASELINE_M8SCI_U3_ELECTRIC_FORCES_AND_CHARGE } from './seeds/m8sci-u3-electric-forces-and-charge';
import { BASELINE_M8SCI_U3_FIELDS_FORCES_WITHOUT_CONTACT } from './seeds/m8sci-u3-fields-forces-without-contact';
import { BASELINE_M8SCI_U3_GRAVITY_MASS_DISTANCE_AND_WEIGHT } from './seeds/m8sci-u3-gravity-mass-distance-and-weight';
import { BASELINE_M8SCI_U3_MAGNETIC_FORCES_AND_ELECTROMAGNETS } from './seeds/m8sci-u3-magnetic-forces-and-electromagnets';
import { BASELINE_M8SCI_U4_ENERGY_TRANSFER_WHEN_MOTION_CHANGES } from './seeds/m8sci-u4-energy-transfer-when-motion-changes';
import { BASELINE_M8SCI_U4_ENERGY_TRANSFORMATIONS_AND_CONSERVATION } from './seeds/m8sci-u4-energy-transformations-and-conservation';
import { BASELINE_M8SCI_U4_KINETIC_ENERGY_MASS_AND_SPEED } from './seeds/m8sci-u4-kinetic-energy-mass-and-speed';
import { BASELINE_M8SCI_U4_POTENTIAL_ENERGY_AND_POSITION } from './seeds/m8sci-u4-potential-energy-and-position';
import { BASELINE_M8SCI_U5_CONDUCTION_CONVECTION_AND_RADIATION } from './seeds/m8sci-u5-conduction-convection-and-radiation';
import { BASELINE_M8SCI_U5_INSULATORS_CONDUCTORS_AND_THERMAL_DESIGN } from './seeds/m8sci-u5-insulators-conductors-and-thermal-design';
import { BASELINE_M8SCI_U5_MASS_MATERIAL_AND_TEMPERATURE_CHANGE } from './seeds/m8sci-u5-mass-material-and-temperature-change';
import { BASELINE_M8SCI_U5_TEMPERATURE_AND_THERMAL_ENERGY } from './seeds/m8sci-u5-temperature-and-thermal-energy';
import { BASELINE_M8SCI_U6_CHANGES_OF_STATE_AND_THERMAL_ENERGY } from './seeds/m8sci-u6-changes-of-state-and-thermal-energy';
import { BASELINE_M8SCI_U6_CHARACTERISTIC_PROPERTIES_IDENTIFY_A_SUBSTANCE } from './seeds/m8sci-u6-characteristic-properties-identify-a-substance';
import { BASELINE_M8SCI_U6_DENSITY_THERMAL_EXPANSION_AND_WHY_WARM_FLUIDS_RISE } from './seeds/m8sci-u6-density-thermal-expansion-and-why-warm-fluids-rise';
import { BASELINE_M8SCI_U6_THE_PARTICLE_MODEL_AND_STATES_OF_MATTER } from './seeds/m8sci-u6-the-particle-model-and-states-of-matter';
import { BASELINE_M8SCI_U7_ELEMENTS_COMPOUNDS_AND_MIXTURES } from './seeds/m8sci-u7-elements-compounds-and-mixtures';
import { BASELINE_M8SCI_U7_INSIDE_THE_ATOM } from './seeds/m8sci-u7-inside-the-atom';
import { BASELINE_M8SCI_U7_MOLECULES_FORMULAS_AND_EXTENDED_STRUCTURES } from './seeds/m8sci-u7-molecules-formulas-and-extended-structures';
import { BASELINE_M8SCI_U7_READING_THE_PERIODIC_TABLE } from './seeds/m8sci-u7-reading-the-periodic-table';
import { BASELINE_M8SCI_U8_EVIDENCE_OF_A_CHEMICAL_REACTION } from './seeds/m8sci-u8-evidence-of-a-chemical-reaction';
import { BASELINE_M8SCI_U8_REACTIONS_THAT_RELEASE_OR_ABSORB_THERMAL_ENERGY } from './seeds/m8sci-u8-reactions-that-release-or-absorb-thermal-energy';
import { BASELINE_M8SCI_U8_REARRANGING_ATOMS_AND_CONSERVATION_OF_MASS } from './seeds/m8sci-u8-rearranging-atoms-and-conservation-of-mass';
import { BASELINE_M8SCI_U8_SYNTHETIC_MATERIALS_FROM_NATURAL_RESOURCES } from './seeds/m8sci-u8-synthetic-materials-from-natural-resources';
import { BASELINE_M8SCI_U9_AMPLITUDE_AND_WAVE_ENERGY } from './seeds/m8sci-u9-amplitude-and-wave-energy';
import { BASELINE_M8SCI_U9_AMPLITUDE_WAVELENGTH_AND_FREQUENCY } from './seeds/m8sci-u9-amplitude-wavelength-and-frequency';
import { BASELINE_M8SCI_U9_WAVE_SPEED_FREQUENCY_AND_WAVELENGTH } from './seeds/m8sci-u9-wave-speed-frequency-and-wavelength';
import { BASELINE_M8SCI_U9_WHAT_A_WAVE_IS } from './seeds/m8sci-u9-what-a-wave-is';
import { BASELINE_M8SCI_U10_ANALOG_AND_DIGITAL_SIGNALS } from './seeds/m8sci-u10-analog-and-digital-signals';
import { BASELINE_M8SCI_U10_LIGHT_VERSUS_SOUND_AND_THE_ELECTROMAGNETIC_SPECTRUM } from './seeds/m8sci-u10-light-versus-sound-and-the-electromagnetic-spectrum';
import { BASELINE_M8SCI_U10_REFLECTION_ABSORPTION_AND_TRANSMISSION } from './seeds/m8sci-u10-reflection-absorption-and-transmission';
import { BASELINE_M8SCI_U10_REFRACTION_BENDING_LIGHT_AT_A_BOUNDARY } from './seeds/m8sci-u10-refraction-bending-light-at-a-boundary';
import { BASELINE_M8GEO_U1_COUNTS_RATES_AND_FAIR_COMPARISON } from './seeds/m8geo-u1-counts-rates-and-fair-comparison';
import { BASELINE_M8GEO_U1_EVALUATING_A_CHOROPLETH } from './seeds/m8geo-u1-evaluating-a-choropleth';
import { BASELINE_M8GEO_U1_MAPS_AS_ARGUMENTS } from './seeds/m8geo-u1-maps-as-arguments';
import { BASELINE_M8GEO_U1_SCALE_OF_ANALYSIS_AND_HIDDEN_PATTERNS } from './seeds/m8geo-u1-scale-of-analysis-and-hidden-patterns';
import { BASELINE_M8GEO_U2_BUFFERS_AND_PROXIMITY } from './seeds/m8geo-u2-buffers-and-proximity';
import { BASELINE_M8GEO_U2_CHANGE_DETECTION_FROM_SATELLITE_DATA } from './seeds/m8geo-u2-change-detection-from-satellite-data';
import { BASELINE_M8GEO_U2_GIS_LAYERS_AND_OVERLAY } from './seeds/m8geo-u2-gis-layers-and-overlay';
import { BASELINE_M8GEO_U2_SITE_SELECTION_WITH_WEIGHTED_CRITERIA } from './seeds/m8geo-u2-site-selection-with-weighted-criteria';
import { BASELINE_M8GEO_U3_NORTH_AMERICA_CLIMATE_CONTROLS_IN_ACTION } from './seeds/m8geo-u3-north-america-climate-controls-in-action';
import { BASELINE_M8GEO_U3_NORTH_AMERICA_HAZARD_REGIONS } from './seeds/m8geo-u3-north-america-hazard-regions';
import { BASELINE_M8GEO_U3_NORTH_AMERICA_LANDFORM_REGIONS } from './seeds/m8geo-u3-north-america-landform-regions';
import { BASELINE_M8GEO_U3_NORTH_AMERICA_RIVER_SYSTEMS_AND_WATERSHEDS } from './seeds/m8geo-u3-north-america-river-systems-and-watersheds';
import { BASELINE_M8GEO_U4_NORTH_AMERICA_ECONOMIC_REGIONS_AND_TRADE } from './seeds/m8geo-u4-north-america-economic-regions-and-trade';
import { BASELINE_M8GEO_U4_NORTH_AMERICA_METROPOLITAN_REGIONS } from './seeds/m8geo-u4-north-america-metropolitan-regions';
import { BASELINE_M8GEO_U4_NORTH_AMERICA_MIGRATION_FLOWS } from './seeds/m8geo-u4-north-america-migration-flows';
import { BASELINE_M8GEO_U4_NORTH_AMERICA_POPULATION_PATTERNS } from './seeds/m8geo-u4-north-america-population-patterns';
import { BASELINE_M8GEO_U5_EVALUATING_POPULATION_PROJECTIONS } from './seeds/m8geo-u5-evaluating-population-projections';
import { BASELINE_M8GEO_U5_MIGRATION_FLOWS_AND_THEIR_EFFECTS } from './seeds/m8geo-u5-migration-flows-and-their-effects';
import { BASELINE_M8GEO_U5_POPULATION_PYRAMIDS_AND_DEPENDENCY } from './seeds/m8geo-u5-population-pyramids-and-dependency';
import { BASELINE_M8GEO_U5_REFUGEES_AND_DISPLACEMENT } from './seeds/m8geo-u5-refugees-and-displacement';
import { BASELINE_M8GEO_U6_CARRYING_CAPACITY_AND_ECOLOGICAL_FOOTPRINT } from './seeds/m8geo-u6-carrying-capacity-and-ecological-footprint';
import { BASELINE_M8GEO_U6_COMPARING_ENERGY_SOURCES } from './seeds/m8geo-u6-comparing-energy-sources';
import { BASELINE_M8GEO_U6_FOOD_SYSTEMS_AND_FOOD_SECURITY } from './seeds/m8geo-u6-food-systems-and-food-security';
import { BASELINE_M8GEO_U6_WATER_SCARCITY_AND_ALLOCATION } from './seeds/m8geo-u6-water-scarcity-and-allocation';
import { BASELINE_M8GEO_U7_COASTAL_RISK_AND_SEA_LEVEL } from './seeds/m8geo-u7-coastal-risk-and-sea-level';
import { BASELINE_M8GEO_U7_HAZARD_RISK_EXPOSURE_AND_VULNERABILITY } from './seeds/m8geo-u7-hazard-risk-exposure-and-vulnerability';
import { BASELINE_M8GEO_U7_MITIGATION_ADAPTATION_AND_RESILIENCE } from './seeds/m8geo-u7-mitigation-adaptation-and-resilience';
import { BASELINE_M8GEO_U7_READING_CLIMATE_TREND_DATA } from './seeds/m8geo-u7-reading-climate-trend-data';
import { BASELINE_M8GEO_U8_COMPOSITE_INDICATORS_AND_INEQUALITY } from './seeds/m8geo-u8-composite-indicators-and-inequality';
import { BASELINE_M8GEO_U8_CONNECTIVITY_AND_THE_DIGITAL_DIVIDE } from './seeds/m8geo-u8-connectivity-and-the-digital-divide';
import { BASELINE_M8GEO_U8_SPECIALIZATION_AND_SUPPLY_CHAIN_RISK } from './seeds/m8geo-u8-specialization-and-supply-chain-risk';
import { BASELINE_M8GEO_U8_WHERE_FACTORIES_LOCATE } from './seeds/m8geo-u8-where-factories-locate';
import { BASELINE_M8GEO_U9_ANALYZING_A_BOUNDARY_DISPUTE } from './seeds/m8geo-u9-analyzing-a-boundary-dispute';
import { BASELINE_M8GEO_U9_CHOKEPOINTS_AND_STRATEGIC_LOCATION } from './seeds/m8geo-u9-chokepoints-and-strategic-location';
import { BASELINE_M8GEO_U9_MARITIME_ZONES_AND_OCEAN_BOUNDARIES } from './seeds/m8geo-u9-maritime-zones-and-ocean-boundaries';
import { BASELINE_M8GEO_U9_TRANSBOUNDARY_PROBLEMS_AND_COOPERATION } from './seeds/m8geo-u9-transboundary-problems-and-cooperation';
import { BASELINE_M8GEO_U10_BUILDING_A_GEOGRAPHIC_ARGUMENT } from './seeds/m8geo-u10-building-a-geographic-argument';
import { BASELINE_M8GEO_U10_COMPARING_TWO_REGIONS_WITH_INDICATORS } from './seeds/m8geo-u10-comparing-two-regions-with-indicators';
import { BASELINE_M8GEO_U10_EVALUATING_A_LAND_USE_PLAN } from './seeds/m8geo-u10-evaluating-a-land-use-plan';
import { BASELINE_M8GEO_U10_SCENARIO_ANALYSIS_FOR_A_CHANGING_PLACE } from './seeds/m8geo-u10-scenario-analysis-for-a-changing-place';
...
export const SEED_BASELINES: TopicNotesBaseline[] = [
  ...
  // MS-core — Grade 8.
  BASELINE_M8MATH_U1_ESTIMATING_AND_LOCATING_IRRATIONAL_NUMBERS,
  BASELINE_M8MATH_U1_RATIONAL_AND_IRRATIONAL_NUMBERS,
  BASELINE_M8MATH_U1_REPEATING_DECIMALS_TO_FRACTIONS,
  BASELINE_M8MATH_U1_SQUARE_ROOTS_AND_CUBE_ROOTS,
  BASELINE_M8MATH_U2_OPERATIONS_IN_SCIENTIFIC_NOTATION,
  BASELINE_M8MATH_U2_PRODUCT_QUOTIENT_AND_POWER_OF_A_POWER_RULES,
  BASELINE_M8MATH_U2_SCIENTIFIC_NOTATION,
  BASELINE_M8MATH_U2_ZERO_AND_NEGATIVE_EXPONENTS,
  BASELINE_M8MATH_U3_COMPARING_PROPORTIONAL_RELATIONSHIPS,
  BASELINE_M8MATH_U3_DERIVING_Y_EQUALS_MX_PLUS_B,
  BASELINE_M8MATH_U3_SLOPE_FROM_SIMILAR_TRIANGLES,
  BASELINE_M8MATH_U3_UNIT_RATE_AS_SLOPE,
  BASELINE_M8MATH_U4_EQUATIONS_WITH_DISTRIBUTION_AND_LIKE_TERMS,
  BASELINE_M8MATH_U4_EQUATIONS_WITH_RATIONAL_COEFFICIENTS,
  BASELINE_M8MATH_U4_EQUATIONS_WITH_VARIABLES_ON_BOTH_SIDES,
  BASELINE_M8MATH_U4_ONE_NONE_OR_INFINITELY_MANY_SOLUTIONS,
  BASELINE_M8MATH_U5_SOLUTIONS_OF_SYSTEMS_AS_INTERSECTION_POINTS,
  BASELINE_M8MATH_U5_SOLVING_SYSTEMS_BY_GRAPHING,
  BASELINE_M8MATH_U5_SOLVING_SYSTEMS_BY_SUBSTITUTION,
  BASELINE_M8MATH_U5_SYSTEMS_WORD_PROBLEMS,
  BASELINE_M8MATH_U6_COMPARING_FUNCTIONS_IN_DIFFERENT_REPRESENTATIONS,
  BASELINE_M8MATH_U6_IDENTIFYING_FUNCTIONS,
  BASELINE_M8MATH_U6_LINEAR_VS_NONLINEAR_FUNCTIONS,
  BASELINE_M8MATH_U6_VOLUME_OF_CYLINDERS_CONES_AND_SPHERES,
  BASELINE_M8MATH_U7_CONSTRUCTING_LINEAR_MODELS_FROM_DESCRIPTIONS,
  BASELINE_M8MATH_U7_DESCRIBING_AND_SKETCHING_QUALITATIVE_GRAPHS,
  BASELINE_M8MATH_U7_INTERPRETING_AND_USING_LINEAR_MODELS,
  BASELINE_M8MATH_U7_RATE_OF_CHANGE_AND_INITIAL_VALUE_FROM_TABLES_AND_GRAPHS,
  BASELINE_M8MATH_U8_CONGRUENCE_THROUGH_RIGID_MOTIONS,
  BASELINE_M8MATH_U8_DILATIONS_AND_SIMILARITY,
  BASELINE_M8MATH_U8_ROTATIONS_ABOUT_THE_ORIGIN,
  BASELINE_M8MATH_U8_TRANSLATIONS_AND_REFLECTIONS,
  BASELINE_M8MATH_U9_PARALLEL_LINES_CUT_BY_A_TRANSVERSAL,
  BASELINE_M8MATH_U9_PYTHAGOREAN_APPLICATIONS_AND_DISTANCE_BETWEEN_POINTS,
  BASELINE_M8MATH_U9_THE_PYTHAGOREAN_THEOREM_AND_ITS_CONVERSE,
  BASELINE_M8MATH_U9_TRIANGLE_ANGLE_SUM_EXTERIOR_ANGLES_AND_AA_SIMILARITY,
  BASELINE_M8MATH_U10_FITTING_A_LINE_TO_A_SCATTER_PLOT,
  BASELINE_M8MATH_U10_SCATTER_PLOTS_AND_ASSOCIATION,
  BASELINE_M8MATH_U10_TWO_WAY_TABLES_AND_RELATIVE_FREQUENCIES,
  BASELINE_M8MATH_U10_USING_A_LINEAR_MODEL_WITH_BIVARIATE_DATA,
  BASELINE_M8ELA_U1_COMPARING_THE_STRUCTURE_OF_TWO_TEXTS,
  BASELINE_M8ELA_U1_HOW_AN_INCIDENT_PROVOKES_A_DECISION,
  BASELINE_M8ELA_U1_HOW_DIALOGUE_PROPELS_ACTION_AND_REVEALS_CHARACTER,
  BASELINE_M8ELA_U1_STRONGEST_TEXTUAL_EVIDENCE,
  BASELINE_M8ELA_U2_ALLUSIONS_AND_ANALOGIES_IN_LITERATURE,
  BASELINE_M8ELA_U2_DRAMATIC_IRONY_SUSPENSE_AND_HUMOR,
  BASELINE_M8ELA_U2_HOW_A_THEME_DEVELOPS_THROUGH_CHARACTER_AND_SETTING,
  BASELINE_M8ELA_U2_MODERN_STORIES_AND_TRADITIONAL_PATTERNS,
  BASELINE_M8ELA_U3_CONNECTIONS_AND_DISTINCTIONS_AMONG_IDEAS,
  BASELINE_M8ELA_U3_HOW_A_CENTRAL_IDEA_DEVELOPS,
  BASELINE_M8ELA_U3_THE_ROLE_OF_A_SENTENCE_IN_A_PARAGRAPH,
  BASELINE_M8ELA_U3_WORD_CHOICE_AND_ANALOGY_IN_INFORMATIONAL_TEXT,
  BASELINE_M8ELA_U4_CHOOSING_THE_MEDIUM_FOR_AN_IDEA,
  BASELINE_M8ELA_U4_HOW_AN_AUTHOR_RESPONDS_TO_OPPOSING_VIEWS,
  BASELINE_M8ELA_U4_IS_THE_REASONING_SOUND,
  BASELINE_M8ELA_U4_WHERE_TWO_TEXTS_DISAGREE_FACT_OR_INTERPRETATION,
  BASELINE_M8ELA_U5_ACTIVE_AND_PASSIVE_VOICE,
  BASELINE_M8ELA_U5_GERUNDS_AND_PARTICIPLES,
  BASELINE_M8ELA_U5_INFINITIVES_AND_VERBAL_PHRASES,
  BASELINE_M8ELA_U5_VERB_MOODS,
  BASELINE_M8ELA_U6_DASHES_AND_COMMAS_FOR_A_BREAK,
  BASELINE_M8ELA_U6_ELLIPSIS_FOR_A_PAUSE_OR_AN_OMISSION,
  BASELINE_M8ELA_U6_SHIFTS_IN_VOICE_AND_MOOD,
  BASELINE_M8ELA_U6_VOICE_AND_MOOD_FOR_EFFECT,
  BASELINE_M8ELA_U7_SHADES_OF_MEANING_DEGREE_AND_FORMALITY,
  BASELINE_M8ELA_U7_VERBAL_IRONY_AND_PUNS,
  BASELINE_M8ELA_U7_VERIFYING_WORD_MEANING_WITH_CONTEXT_AND_A_DICTIONARY,
  BASELINE_M8ELA_U7_WORD_FAMILIES_FROM_A_SHARED_ROOT,
  BASELINE_M8ELA_U8_A_CLAIM_THAT_ANSWERS_THE_OPPOSING_CLAIM,
  BASELINE_M8ELA_U8_COHESION_AMONG_CLAIM_COUNTERCLAIM_AND_EVIDENCE,
  BASELINE_M8ELA_U8_FORMAL_STYLE_IN_ARGUMENT,
  BASELINE_M8ELA_U8_REBUTTING_WITH_EVIDENCE_FROM_CREDIBLE_SOURCES,
  BASELINE_M8ELA_U9_ESTABLISHING_POINT_OF_VIEW_AND_SHIFTING_TIME_IN_A_NARRATIVE,
  BASELINE_M8ELA_U9_ORGANIZING_INFORMATION_INTO_BROADER_CATEGORIES,
  BASELINE_M8ELA_U9_PRECISE_LANGUAGE_AND_DOMAIN_VOCABULARY,
  BASELINE_M8ELA_U9_REFLECTION_AND_A_NARRATIVE_CONCLUSION,
  BASELINE_M8ELA_U10_BLENDING_A_QUOTATION_INTO_YOUR_OWN_SENTENCE,
  BASELINE_M8ELA_U10_FOLLOWING_A_STANDARD_CITATION_FORMAT,
  BASELINE_M8ELA_U10_GENERATING_RELATED_RESEARCH_QUESTIONS,
  BASELINE_M8ELA_U10_USING_SEARCH_TERMS_EFFECTIVELY,
  BASELINE_M8SCI_U1_FORCES_AND_NET_FORCE,
  BASELINE_M8SCI_U1_MOTION_REFERENCE_POINTS_AND_SPEED,
  BASELINE_M8SCI_U1_READING_DISTANCE_TIME_GRAPHS,
  BASELINE_M8SCI_U1_VELOCITY_AND_ACCELERATION,
  BASELINE_M8SCI_U2_COLLISIONS_AND_DESIGNING_FOR_SAFETY,
  BASELINE_M8SCI_U2_NEWTONS_FIRST_LAW_INERTIA_AND_FRICTION,
  BASELINE_M8SCI_U2_NEWTONS_SECOND_LAW_FORCE_MASS_AND_ACCELERATION,
  BASELINE_M8SCI_U2_NEWTONS_THIRD_LAW_ACTION_REACTION_PAIRS,
  BASELINE_M8SCI_U3_ELECTRIC_FORCES_AND_CHARGE,
  BASELINE_M8SCI_U3_FIELDS_FORCES_WITHOUT_CONTACT,
  BASELINE_M8SCI_U3_GRAVITY_MASS_DISTANCE_AND_WEIGHT,
  BASELINE_M8SCI_U3_MAGNETIC_FORCES_AND_ELECTROMAGNETS,
  BASELINE_M8SCI_U4_ENERGY_TRANSFER_WHEN_MOTION_CHANGES,
  BASELINE_M8SCI_U4_ENERGY_TRANSFORMATIONS_AND_CONSERVATION,
  BASELINE_M8SCI_U4_KINETIC_ENERGY_MASS_AND_SPEED,
  BASELINE_M8SCI_U4_POTENTIAL_ENERGY_AND_POSITION,
  BASELINE_M8SCI_U5_CONDUCTION_CONVECTION_AND_RADIATION,
  BASELINE_M8SCI_U5_INSULATORS_CONDUCTORS_AND_THERMAL_DESIGN,
  BASELINE_M8SCI_U5_MASS_MATERIAL_AND_TEMPERATURE_CHANGE,
  BASELINE_M8SCI_U5_TEMPERATURE_AND_THERMAL_ENERGY,
  BASELINE_M8SCI_U6_CHANGES_OF_STATE_AND_THERMAL_ENERGY,
  BASELINE_M8SCI_U6_CHARACTERISTIC_PROPERTIES_IDENTIFY_A_SUBSTANCE,
  BASELINE_M8SCI_U6_DENSITY_THERMAL_EXPANSION_AND_WHY_WARM_FLUIDS_RISE,
  BASELINE_M8SCI_U6_THE_PARTICLE_MODEL_AND_STATES_OF_MATTER,
  BASELINE_M8SCI_U7_ELEMENTS_COMPOUNDS_AND_MIXTURES,
  BASELINE_M8SCI_U7_INSIDE_THE_ATOM,
  BASELINE_M8SCI_U7_MOLECULES_FORMULAS_AND_EXTENDED_STRUCTURES,
  BASELINE_M8SCI_U7_READING_THE_PERIODIC_TABLE,
  BASELINE_M8SCI_U8_EVIDENCE_OF_A_CHEMICAL_REACTION,
  BASELINE_M8SCI_U8_REACTIONS_THAT_RELEASE_OR_ABSORB_THERMAL_ENERGY,
  BASELINE_M8SCI_U8_REARRANGING_ATOMS_AND_CONSERVATION_OF_MASS,
  BASELINE_M8SCI_U8_SYNTHETIC_MATERIALS_FROM_NATURAL_RESOURCES,
  BASELINE_M8SCI_U9_AMPLITUDE_AND_WAVE_ENERGY,
  BASELINE_M8SCI_U9_AMPLITUDE_WAVELENGTH_AND_FREQUENCY,
  BASELINE_M8SCI_U9_WAVE_SPEED_FREQUENCY_AND_WAVELENGTH,
  BASELINE_M8SCI_U9_WHAT_A_WAVE_IS,
  BASELINE_M8SCI_U10_ANALOG_AND_DIGITAL_SIGNALS,
  BASELINE_M8SCI_U10_LIGHT_VERSUS_SOUND_AND_THE_ELECTROMAGNETIC_SPECTRUM,
  BASELINE_M8SCI_U10_REFLECTION_ABSORPTION_AND_TRANSMISSION,
  BASELINE_M8SCI_U10_REFRACTION_BENDING_LIGHT_AT_A_BOUNDARY,
  BASELINE_M8GEO_U1_COUNTS_RATES_AND_FAIR_COMPARISON,
  BASELINE_M8GEO_U1_EVALUATING_A_CHOROPLETH,
  BASELINE_M8GEO_U1_MAPS_AS_ARGUMENTS,
  BASELINE_M8GEO_U1_SCALE_OF_ANALYSIS_AND_HIDDEN_PATTERNS,
  BASELINE_M8GEO_U2_BUFFERS_AND_PROXIMITY,
  BASELINE_M8GEO_U2_CHANGE_DETECTION_FROM_SATELLITE_DATA,
  BASELINE_M8GEO_U2_GIS_LAYERS_AND_OVERLAY,
  BASELINE_M8GEO_U2_SITE_SELECTION_WITH_WEIGHTED_CRITERIA,
  BASELINE_M8GEO_U3_NORTH_AMERICA_CLIMATE_CONTROLS_IN_ACTION,
  BASELINE_M8GEO_U3_NORTH_AMERICA_HAZARD_REGIONS,
  BASELINE_M8GEO_U3_NORTH_AMERICA_LANDFORM_REGIONS,
  BASELINE_M8GEO_U3_NORTH_AMERICA_RIVER_SYSTEMS_AND_WATERSHEDS,
  BASELINE_M8GEO_U4_NORTH_AMERICA_ECONOMIC_REGIONS_AND_TRADE,
  BASELINE_M8GEO_U4_NORTH_AMERICA_METROPOLITAN_REGIONS,
  BASELINE_M8GEO_U4_NORTH_AMERICA_MIGRATION_FLOWS,
  BASELINE_M8GEO_U4_NORTH_AMERICA_POPULATION_PATTERNS,
  BASELINE_M8GEO_U5_EVALUATING_POPULATION_PROJECTIONS,
  BASELINE_M8GEO_U5_MIGRATION_FLOWS_AND_THEIR_EFFECTS,
  BASELINE_M8GEO_U5_POPULATION_PYRAMIDS_AND_DEPENDENCY,
  BASELINE_M8GEO_U5_REFUGEES_AND_DISPLACEMENT,
  BASELINE_M8GEO_U6_CARRYING_CAPACITY_AND_ECOLOGICAL_FOOTPRINT,
  BASELINE_M8GEO_U6_COMPARING_ENERGY_SOURCES,
  BASELINE_M8GEO_U6_FOOD_SYSTEMS_AND_FOOD_SECURITY,
  BASELINE_M8GEO_U6_WATER_SCARCITY_AND_ALLOCATION,
  BASELINE_M8GEO_U7_COASTAL_RISK_AND_SEA_LEVEL,
  BASELINE_M8GEO_U7_HAZARD_RISK_EXPOSURE_AND_VULNERABILITY,
  BASELINE_M8GEO_U7_MITIGATION_ADAPTATION_AND_RESILIENCE,
  BASELINE_M8GEO_U7_READING_CLIMATE_TREND_DATA,
  BASELINE_M8GEO_U8_COMPOSITE_INDICATORS_AND_INEQUALITY,
  BASELINE_M8GEO_U8_CONNECTIVITY_AND_THE_DIGITAL_DIVIDE,
  BASELINE_M8GEO_U8_SPECIALIZATION_AND_SUPPLY_CHAIN_RISK,
  BASELINE_M8GEO_U8_WHERE_FACTORIES_LOCATE,
  BASELINE_M8GEO_U9_ANALYZING_A_BOUNDARY_DISPUTE,
  BASELINE_M8GEO_U9_CHOKEPOINTS_AND_STRATEGIC_LOCATION,
  BASELINE_M8GEO_U9_MARITIME_ZONES_AND_OCEAN_BOUNDARIES,
  BASELINE_M8GEO_U9_TRANSBOUNDARY_PROBLEMS_AND_COOPERATION,
  BASELINE_M8GEO_U10_BUILDING_A_GEOGRAPHIC_ARGUMENT,
  BASELINE_M8GEO_U10_COMPARING_TWO_REGIONS_WITH_INDICATORS,
  BASELINE_M8GEO_U10_EVALUATING_A_LAND_USE_PLAN,
  BASELINE_M8GEO_U10_SCENARIO_ANALYSIS_FOR_A_CHANGING_PLACE,
];
