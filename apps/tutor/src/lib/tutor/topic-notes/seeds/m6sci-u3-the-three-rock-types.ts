/**
 * Grade 6 Science — Unit 3 CED 3.3: The Three Rock Types.
 *
 * Auto-extracted from the corresponding lesson plan
 * (evelyn.ms.m6sci.the-three-rock-types.v1). Hand-edit freely after extraction; bump
...
export const BASELINE_M6SCI_U3_THE_THREE_ROCK_TYPES: TopicNotesBaseline = {
  ...
  theory: [
    ...
    { loId: 'm6sci.the-three-rock-types', kind: 'definition', title: 'igneous rock', content: 'rock that forms when magma or lava cools and hardens into a solid.' },
    { loId: 'm6sci.the-three-rock-types', kind: 'definition', title: 'magma', content: 'melted rock while it is still underground.' },
    { loId: 'm6sci.the-three-rock-types', kind: 'definition', title: 'lava', content: `melted rock once it reaches the surface, through a volcano or a crack in the ground.` },
    { loId: 'm6sci.the-three-rock-types', kind: 'definition', title: 'sedimentary rock', content: 'rock that forms when layers of sediment are compacted and cemented together.' },
    { loId: 'm6sci.the-three-rock-types', kind: 'definition', title: 'sediment', content: `loose material such as grains of sand, mud, or the remains of shells and other once-living things.` },
    { loId: 'm6sci.the-three-rock-types', kind: 'definition', title: 'metamorphic rock', content: `rock that forms when an existing rock is changed by heat and pressure without completely melting.` },
  ],
  methods: [
    {
      title: 'Worked igneous from formation',
      steps: [
      ...
      example: { problem: `A rock sample is described this way: it formed when melted rock reached Earth's surface through a volcano, then cooled and hardened within a few hours. The crystals in the sample are too small to see or pick out individually, even with a hand lens. What type of rock is this, and why?`, solution: `Igneous rock. It formed from lava that reached Earth's surface and cooled quickly, which hardened it into rock with crystals too small to see individually -- similar to basalt.` },
      relatedLoIds: ['m6sci.the-three-rock-types'],
    },
    {
      title: 'Worked metamorphic from existing rock',
      steps: [
      ...
      example: { problem: `A geologist describes a rock sample this way: it started out as shale, a sedimentary rock made from layers of compacted, cemented mud. Then, deep underground, heat and intense pressure changed it without ever fully melting it. The sample now shows tightly packed, shiny mineral flakes lined up in flat bands, and it splits easily into thin, smooth sheets. What type of rock is the sample now, and what type of rock was it before the change?`, solution: `Metamorphic rock. It started as shale, a sedimentary rock made from compacted mud layers, and heat and intense pressure changed it into a rock with aligned mineral bands that split into thin sheets, without ever melting it. This description matches slate.` },
      relatedLoIds: ['m6sci.the-three-rock-types'],
    },
  ],
  pointers: [
    { content: `Students often say "Big crystals mean the rock is very old." — Crystal size tells you about the COOLING RATE, not the age. Magma that cools slowly underground grows large crystals whether that happened a short time ago or a very long time ago, so a rock could be young and coarse-crystaled, or old and fine-crystaled. Working out an actual age uses a different method entirely, taught in a later lesson, and it is never read off crystal size.`, kind: 'common-error' },
    { content: `Students often say "Old rocks always cooled from magma, so being old proves a rock is igneous." — Age has nothing to do with which of the three families a rock belongs to. A rock formed a very long time ago could be igneous, sedimentary, or metamorphic, and so could a rock formed recently. What sorts a rock into a family is the process that made it -- cooling from a melt, sediment pressed together, or an existing rock changed by heat and pressure -- never how much time has passed.`, kind: 'common-error' },
    { content: `Rocks are sorted into three families by the PROCESS that formed them: igneous, sedimentary, or metamorphic.`, kind: 'tip' },
    { content: `Igneous rock forms when magma (underground) or lava (surface) cools and hardens. Slow cooling underground gives large crystals; fast cooling at the surface gives small ones.`, kind: 'tip' },
    { content: `Sedimentary rock forms when sediment -- loose grains, mud, or shell and coral fragments -- settles in layers and is compacted and cemented together. No new crystals grow in this process.`, kind: 'tip' },
    { content: `Metamorphic rock forms when an existing rock, of any of the three families, is changed by heat and pressure without fully melting.`, kind: 'tip' },
