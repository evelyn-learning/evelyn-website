/**
 * Grade 8 English Language Arts — Unit 8 CED 8.1: A Claim That Answers the Opposing Claim.
 *
 * Auto-extracted from the corresponding lesson plan
 * (evelyn.ms.m8ela.a-claim-that-answers-the-opposing-claim.v1). Hand-edit freely after extraction; bump
  ...
  methods: [
    {
      ...
      example: { problem: `Here is a claim and the strongest thing the other side says. Build one claim sentence that distinguishes the claim from the opposing claim.

CLAIM: Ridgeview should spend the eighth-grade fund on a class trip instead of on the spring dance.

WHAT THE OTHER SIDE SAYS: The spring dance costs nothing to attend. A trip would add a cost for every family, so the students who cannot pay would be the ones who stay behind.`, solution: `"Although a trip would add a cost that the spring dance does not, Ridgeview should spend the eighth-grade fund on a class trip instead of on the spring dance, because the spring dance lasts two hours and half the grade does not come to it." The although part carries the strongest objection in words the other side would use, the middle part states the position, and the because part gives one reason without trying to settle the objection.` },
      relatedLoIds: ['m8ela.a-claim-that-answers-the-opposing-claim'],
    },
    {
      title: 'Worked repair a collapsed claim',
      steps: [
...
Find both errors and repair the sentence.`, solution: `Two errors. The although part is the writer's own position flipped to the negative, so it names no reason a reader could weigh, and both objections the other side actually raised are left out of the sentence. The middle part says only what the school should not do, so it asks for nothing. Repaired: "Although a club somebody was made to join stops being a club, Marlowe should require every student to join one club, because a requirement is the only thing that reaches the students who never sign up for anything."` },
      relatedLoIds: ['m8ela.a-claim-that-answers-the-opposing-claim'],
    },
  ],
  pointers: [
    { content: `Students often say "Draft 1 works, because it begins with "Although" and admits that people disagree." — Put the test question to the clause: why would they say that? The words "some people disagree" cannot answer it, so nothing has been conceded and nothing has been distinguished. The objection was sitting right there in the argument, which is that an October field day falls in the middle of the fall sports season. Put that in and the sentence starts doing its job: "Although an October field day would fall in the middle of the fall sports season, Northgate should move field day to October, because a June afternoon on that field is hot enough to send half the grade indoors."`, kind: 'common-error' },
    { content: `Students often say "Draft 2 is the better one, because it takes the real objection and answers it right away." — Draft 2 has stopped being a claim. It concedes, then argues, then states the position, which is three jobs in one sentence, and the position now arrives at the very end after a "so", where a reader has already lost the thread. A claim sentence names the objection and lands on your side; the answer to that objection, with evidence behind it, is a rebuttal and belongs in a later part of the essay. Cut it back to the shape: "Although an October field day would land in the middle of fall sports, Northgate should move field day to October, because an October date leaves the last weeks of school free." The release from practice is a good answer, and it goes in the paragraph where you answer.`, kind: 'common-error' },
    { content: `A distinguishing claim answers the other side inside the claim sentence: "Although [the strongest opposing point], [what should happen], because [your strongest reason]."`, kind: 'tip' },
    { content: `The although part belongs to the other side and cannot stand as a sentence on its own, which is why it never takes the paragraph over. Put it first, so the sentence lands on your position.`, kind: 'tip' },
    { content: `Concede the strongest real objection, never the easiest one. Two tests: would somebody on that side call it their point, and would it still stand if the easy problems around it were fixed?`, kind: 'tip' },
    { content: `The middle part has to say what should happen. WRONG: "Although the cost is real, the school should not go on doing it this way." CORRECT: "Although the cost is real, the school should move practice to the morning." Cover the although part and read what is left; if it does not ask for something, there is no claim in the sentence.`, kind: 'tip' },
    { content: `The two parts have to be on opposite sides of the same question. A clause that concedes something which is really an argument for your own side concedes nothing at all.`, kind: 'tip' },
    { content: `The claim sentence names the objection; it does not defeat it. Conceding is not surrendering, and the answer to the objection belongs in a later part of the essay, not in this sentence.`, kind: 'tip' },
    { content: `The although clause is NOT a sentence on its own—it leans forward and needs the middle part to catch it. If you read only the although part and it sounds complete, you've written the wrong thing.`, kind: 'gotcha' },
    { content: `Don't concede the easiest objection the other side could make. Conceding a weak point makes a reader think you missed or dodged the strong one. Ask: would they claim this as their point? Would it still matter if the easy problems got fixed?`, kind: 'common-error' },
    { content: `Cover the although part with your hand and read only what's left. If those words don't ask for something the school could actually do on Monday, you have no claim—you only have a denial.`, kind: 'tip' },
    { content: `The although part must push against the exact thing you're asking for, not a different question. If your objection and your position don't touch the same topic, you've wandered into two arguments instead of one.`, kind: 'edge-case' },
    { content: `Don't put your answer to the objection inside the claim sentence. Naming the objection and defeating it are two different jobs. The claim sentence concedes; the rebuttal paragraph argues back.`, kind: 'common-error' },
    { content: `Don't use 'Although some people say' or 'Although some people disagree.' Those are labels, not reasons. Replace them with the actual objection in the words the other side would use.`, kind: 'vocab-note' },
    { content: `Don't concede a point that actually supports your own side. WRONG: 'Although a trip would get students home safely, the school should fund a trip.' That's not a concession—it's your own reason hiding in the wrong place.`, kind: 'gotcha' },
  ],
};
