/**
 * Grade 6 World Geography — Unit 8 CED 8.2: How People Perceive Places Differently.
 *
 * Auto-extracted from the corresponding lesson plan
 * (evelyn.ms.m6geo.how-people-perceive-places-differently.v1). Hand-edit freely after extraction; bump
...
export const BASELINE_M6GEO_U8_HOW_PEOPLE_PERCEIVE_PLACES_DIFFERENTLY: TopicNotesBaseline = {
  ...
  theory: [
    ...
    { loId: 'm6geo.how-people-perceive-places-differently', kind: 'definition', title: 'perception', content: `the way one particular person understands or describes a place, built out of that person's own experience of it.` },
    { loId: 'm6geo.how-people-perceive-places-differently', kind: 'definition', title: 'resident', content: `a person who lives in a place and experiences it through routine, over and over, across many ordinary days.` },
    { loId: 'm6geo.how-people-perceive-places-differently', kind: 'definition', title: 'visitor', content: `a person who is experiencing a place for the first time, or without a routine there.` },
    { loId: 'm6geo.how-people-perceive-places-differently', kind: 'definition', title: 'familiar', content: `something a person has experienced often enough that it feels ordinary rather than noticeable.` },
    { loId: 'm6geo.how-people-perceive-places-differently', kind: 'definition', title: 'point of comparison', content: `the place a person is already used to, which they measure a new place against without meaning to.` },
  ],
  methods: [
    {
      title: 'Worked market square fast or slow',
      steps: [
    ...
    },
    {
      ...
      example: { problem: `In the invented town of Fenwick, a resident named Deshawn walks up and down the hill near his home almost every day, and he says the hill is not very steep. A visitor named Priya, who is used to walking on flat land in her own town, is walking up the hill for the first time, and she says it is quite steep. A student concludes: "Priya must be exaggerating, because Deshawn has lived there and knows the hill best." Two things are wrong with that conclusion. Find both and correct them, using only what the scenario states about each person.`, solution: `Both parts of the conclusion are wrong because they treat one person's view as simply true. Priya's sense that the hill is steep traces to being used to flat land at home. Deshawn's sense that it is not very steep traces to walking it almost every day. Neither description is more correct; both are accurate reports built from different stated experience.` },
      relatedLoIds: ['m6geo.how-people-perceive-places-differently'],
    },
  ],
  pointers: [
    { content: `Students often say "A resident's description of a place is always the correct one, since a resident knows a place best." — A resident's long experience does not make their description more correct than a visitor's -- it only makes it come from a different, longer kind of experience. A visitor's fresh eyes can notice real things a resident has stopped noticing, such as an unusual smell or an unusually tall building. Both descriptions can be equally accurate reports of what each person actually experienced. WRONG: "the resident's view is the correct one." CORRECT: "the resident's view and the visitor's view are both accurate, built from different experience with the same place."`, kind: 'common-error' },
    { content: `Students often say "If two people describe the same place differently, it must be because one of them has a better personality for noticing things." — A difference in perception traces to a stated experience: how long a person has been somewhere, what they do there routinely, or what they are used to comparing it to from somewhere else. It does not trace to one person simply being a better or more careful kind of person. A visitor notices a hill because that visitor is not used to hills at home, not because that visitor is more observant than a resident. WRONG: "one of them has a better personality for noticing things." CORRECT: "one of them has different stated experience with the place."`, kind: 'common-error' },
    { content: `Perception is how one particular person understands or describes a place, and it comes from that person's own experience with the place, not from the place itself changing.`, kind: 'tip' },
    { content: `A resident's perception is shaped by routine -- being in a place again and again teaches things a short visit cannot.`, kind: 'tip' },
    { content: `A visitor's perception is shaped by newness, and also by whatever place the visitor is already used to comparing things to.`, kind: 'tip' },
