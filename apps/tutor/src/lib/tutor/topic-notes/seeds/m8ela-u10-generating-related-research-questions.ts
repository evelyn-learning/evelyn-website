/**
 * Grade 8 English Language Arts — Unit 10 CED 10.1: Generating Related Research Questions.
 *
 * Auto-extracted from the corresponding lesson plan
 * (evelyn.ms.m8ela.generating-related-research-questions.v1). Hand-edit freely after extraction; bump
...
export const BASELINE_M8ELA_U10_GENERATING_RELATED_RESEARCH_QUESTIONS: TopicNotesBaseline = {
  baselineId: 'evelyn.ms.m8ela.generating-related-research-questions.v1',
  course: 'Grade 8 English Language Arts',
  cedUnit: 10,
  cedTopic: '10.1',
  cedTitle: 'Generating Related Research Questions',
  planId: 'evelyn.ms.m8ela.generating-related-research-questions.v1',
  baselineVersion: 1,
  lastUpdatedAt: '2026-09-20',
  sources: [{ type: 'plan', planId: 'evelyn.ms.m8ela.generating-related-research-questions.v1' }],
  theory: [
    { loId: 'm8ela.generating-related-research-questions', content: `A SUB-QUESTION IS A SMALLER QUESTION THAT BELONGS TO THE SAME PROJECT. You already know how to turn a topic into one focused research question, and you already know that a good question keeps handing you more questions while you work. This lesson is about producing those on purpose instead of waiting for them to arrive. Take the main question "How do street trees change how hot a city block gets on a summer afternoon?" A sub-question is any smaller question whose answer would go in the report that answers it: "What is it about a tree that cools the air under it?" is one. The main question stays the project. The sub-questions are how you get through it.` },
    { loId: 'm8ela.generating-related-research-questions', content: `FOUR AVENUES GENERATE THE SET: CAUSE, EFFECT, COMPARISON, AND CHANGE OVER TIME. Run each avenue at the main question and write down what comes out. CAUSE, what makes this happen: "What is it about a tree that cools the air under it?" EFFECT, what it changes: "How does a cooler block change what people do outside on a hot afternoon?" COMPARISON, what it is like and unlike: "How does a block lined with trees compare with a block the same size that has none?" CHANGE OVER TIME, how it has moved: "How does the cooling change as the trees grow from saplings into full-sized trees?" One pass of the four avenues, four sub-questions, and about an afternoon of reading behind each.` },
    { loId: 'm8ela.generating-related-research-questions', content: `A SET IS GOOD WHEN THE AVENUES ARE DIFFERENT, NOT WHEN THE LIST IS LONG. Six sub-questions that all ask about causes give you one deep hole and three walls you never looked at. So before you start reading, lay the set out and label each one with its avenue. If the same label turns up three times, you have found the hole: run one of the missing avenues at the main question and write down the sub-question it produces. A set of four on four avenues tells you more than a list of ten on one.` },
    { loId: 'm8ela.generating-related-research-questions', content: `A SUB-QUESTION INHERITS EVERY LIMIT THE MAIN QUESTION CARRIES. Your main question arrived with its limits already on it — which kind, which place, which time — and a sub-question keeps all of them. Drop one and the question stops being smaller than the main question and starts being bigger, which makes it a different project that has swallowed yours. WRONG FOR THIS MAIN QUESTION: "How do cities around the world deal with summer heat?" CORRECT: "How does a block lined with trees compare with a block the same size that has none?" The second one can be answered in an afternoon, and the answer goes straight into the report. The first one is a book.` },
    { loId: 'm8ela.generating-related-research-questions', content: `THE SAME-REPORT TEST SORTS EVERY CANDIDATE IN ONE MOVE. Imagine the answer written down, then ask one question about it: would that answer go in the report that answers the main question, or would it need a report of its own? That is the whole test, and it works down a list fast. Being about the same subject is not enough to pass it. "How many people live on the block with the trees?" is about the very same block, and its answer belongs in a report about who lives there, not in a report about heat.` },
    { loId: 'm8ela.generating-related-research-questions', content: `THREE SHAPES WANDER OFF, AND EACH ONE HAS A TELL. A candidate that CHANGES THE SUBJECT keeps the topic's words while its answer heads somewhere else; the tell is that you cannot name the sentence of your report it would go in. A candidate that DROPS A LIMIT is bigger than the main question; the tell is that answering it would take longer than the whole project. A RESTATEMENT says the main question over again in different words; the tell is that it opens nothing, because you already have that question. Cutting one is not throwing away the interest. Write it on its own line and let it be somebody's project later.` },
    { loId: 'm8ela.generating-related-research-questions', kind: 'definition', title: 'sub-question', content: `a smaller question generated from a main research question, whose answer belongs in the report that answers the main question.` },
    { loId: 'm8ela.generating-related-research-questions', kind: 'definition', title: 'avenue', content: `one direction a sub-question can explore. This lesson uses four: cause, effect, comparison, and change over time.` },
    { loId: 'm8ela.generating-related-research-questions', kind: 'definition', title: 'the same-report test', content: `imagining the answer to a candidate sub-question and asking whether that answer would go in the report that answers the main question, or would need a report of its own.` },
    { loId: 'm8ela.generating-related-research-questions', kind: 'definition', title: 'restatement', content: `a candidate that says the main question over again in different words, so it opens nothing the researcher did not already have.` },
    { loId: 'm8ela.generating-related-research-questions', kind: 'definition', title: 'question set', content: `the group of sub-questions generated from one main question, checked for holes by labeling each one with its avenue.` },
  ],
  methods: [
    {
      title: 'Worked generate a set from one question',
      steps: [
      ...
      example: { problem: `Here is a main research question. Generate a set of sub-questions from it, then check the set and two candidates a group member added.

MAIN QUESTION: "How did the new bike lane on Pearl Street change how Hollis Middle School students get to school?"`, solution: `A set of four, one per avenue. CAUSE: "How were students getting to school on Pearl Street before the lane was built?" EFFECT: "What has changed at the bike racks and in the drop-off line since the lane opened?" COMPARISON: "How do students who live on streets with no bike lane get to school now?" CHANGE OVER TIME: "How has the number of students riding changed across each of the two years since the lane opened?" Of the two added candidates, the budget question is parked as its own project, and "Why do people ride bikes?" is repaired by putting the main question's limits back on it.` },
      relatedLoIds: ['m8ela.generating-related-research-questions'],
    },
    {
      title: 'Worked sort five candidates',
      steps: [
      ...
      example: { problem: `Here is a main question and five candidate sub-questions. Sort the candidates into the ones that advance the main question and the ones that wander off it, and name what is wrong with each one that wanders.
...
(5) "How did railroads change the United States?"`, solution: `Advancing: (1) and (2), both on the effect avenue. Wandering: (3), whose answer is a name and a date that no sentence of this report would use; (4), which changes the subject from a railcar then to a truck now; and (5), which drops every limit and becomes a different project. The sort also exposes a hole, because no candidate asks how city food changed across the years the railcars spread, so the set needs a change-over-time question added before the reading starts.` },
      relatedLoIds: ['m8ela.generating-related-research-questions'],
    },
  ],
  pointers: [
    { content: `Students often say "The list is finished, because it has six sub-questions and every one of them is about the mill." — Label them. Why the mill closed, why the company moved, why no buyer turned up, why the downtown stores closed, why the site is still empty: that is the cause avenue asked five times. The set is one deep hole with three walls nobody has looked at. Run the missing avenues at the main question and the holes fill in fast. EFFECT: "What happened to the streets around the mill in the years after it closed?" COMPARISON: "How did a nearby town that kept its mill change over the same years?" CHANGE OVER TIME: "What did Ardmore look like five years after the closing compared with one year after?" Four sub-questions on four avenues tell you more than ten on one.`, kind: 'common-error' },
    { content: `Students often say "The last question belongs on the list too, because the whole project is about a paper mill." — Run the same-report test. Imagine the answer: wood chips are cooked into pulp, and the pulp is pressed and dried into sheets. Now find the sentence in a report about how the closing changed Ardmore where that would go. There is not one. It is the opening paragraph of a different report, about how paper gets made, and it would be a good report. So the move is not to delete the question. Write it on its own line, under its own heading, and leave the project you are actually doing alone.`, kind: 'common-error' },
    { content: `A sub-question is a smaller question whose answer belongs in the report that answers the main question. The main question stays the project; the sub-questions are how you get through it.`, kind: 'tip' },
    { content: `Generate the set by running four avenues at the main question: cause, effect, comparison, and change over time. One pass of the four gives you a set instead of a pile.`, kind: 'tip' },
    { content: `A set is good when the avenues are different, not when the list is long. Label each sub-question with its avenue, and if one label turns up three times, run a missing avenue and write down what comes out.`, kind: 'tip' },
    { content: `A sub-question inherits every limit the main question carries — which kind, which place, which time. Drop one and the question is bigger than the main question, which makes it a different project rather than a smaller one.`, kind: 'tip' },
    { content: `The same-report test settles a candidate in one move: imagine the answer, then ask whether that sentence would go in the report that answers the main question or would need a report of its own. Being about the same subject is not enough.`, kind: 'tip' },
    { content: `Three shapes wander off: one changes the subject, one drops a limit, and one restates the main question in different words. WRONG FOR THIS MAIN QUESTION: "How do cities around the world deal with summer heat?" CORRECT: "How does a block lined with trees compare with a block the same size that has none?" Cutting a candidate does not throw away the interest — write it on its own line and let it be a project later.`, kind: 'tip' },
  ],
};
