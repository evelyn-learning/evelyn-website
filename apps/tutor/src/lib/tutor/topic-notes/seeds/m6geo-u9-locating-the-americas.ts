/**
 * Grade 6 World Geography — Unit 9 CED 9.2: Locating the Americas.
 *
 * Auto-extracted from the corresponding lesson plan
 * (evelyn.ms.m6geo.locating-the-americas.v1). Hand-edit freely after extraction; bump
  ...
  methods: [
    {
      ...
      example: { problem: `A delivery van drives the whole way over land, starting at a warehouse near the northern edge of North America and ending at a warehouse near the southern tip of South America. The van never crosses open ocean and never drives onto an island. Name the regions the van passes through, in order, and explain why the Caribbean is not on that list.`, solution: `North America, then Central America, then South America. The Caribbean is left off the list because it is a region of islands rather than a connected mainland, and a route that never crosses open ocean or drives onto an island cannot pass through it.` },
      relatedLoIds: ['m6geo.locating-the-americas'],
    },
    {
      title: 'Worked equator and continent claims',
      steps: [
      ...
      example: { problem: `A student writes: "All four American regions have land south of the Equator, since South America does. And Central America is one of Earth's continents, the same as North America and South America." Both sentences are wrong. Correct each one.`, solution: `Only South America has land south of the Equator; North America, Central America, and the Caribbean lie entirely in the Northern Hemisphere. North America and South America are two of Earth's seven continents, but Central America is not a continent -- it is the isthmus joining the two continents -- and neither is the Caribbean, which is a set of islands rather than one connected landmass.` },
      relatedLoIds: ['m6geo.locating-the-americas'],
    },
  ],
  pointers: [
    { content: `Students often say "Central America and the Caribbean are both continents, just smaller than North America and South America." — North America and South America are two of Earth's seven continents. Central America is a narrow isthmus that joins those two continents, not a continent of its own, and the Caribbean is a region of islands, also not one of the seven continents. WRONG: "Central America and the Caribbean are smaller continents." CORRECT: "Central America and the Caribbean are named regions that are not continents at all."`, kind: 'common-error' },
    { content: `Students often say "Since South America has land south of the Equator, North America must too, since the two are neighbors." — Whether a region has land south of the Equator depends on where that region's own land actually sits, not on which region it happens to connect to. North America lies entirely north of the Equator even though it connects directly to South America, which does have land south of the Equator. Each region has to be checked against the Equator on its own, the same way this row's worked example checked North America, Central America, and the Caribbean one at a time rather than assuming they all matched their neighbor.`, kind: 'common-error' },
    { content: `Four names divide this stretch of the world, north to south: North America, Central America, the Caribbean, and South America.`, kind: 'tip' },
    { content: `North America and South America are two of Earth's seven continents. North America is the northernmost of the four regions, and South America is the southernmost.`, kind: 'tip' },
    { content: `Central America is the isthmus -- a narrow strip of land -- that joins North America and South America directly, lying south of North America and north of South America.`, kind: 'tip' },
