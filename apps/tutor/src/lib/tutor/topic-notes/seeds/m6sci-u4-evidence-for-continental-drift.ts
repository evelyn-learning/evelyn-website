/**
 * Grade 6 Science — Unit 4 CED 4.1: Evidence for Continental Drift.
 *
 * Auto-extracted from the corresponding lesson plan
 * (evelyn.ms.m6sci.evidence-for-continental-drift.v1). Hand-edit freely after extraction; bump
  ...
  methods: [
    {
      ...
      example: { problem: `Fossils of Mesosaurus, a reptile that lived only in fresh water and was far too weak a swimmer to cross open ocean, are found in matching-age rock in South America and in southern Africa -- continents that today sit on opposite sides of the Atlantic Ocean. Explain why this fossil pattern is evidence that the two continents were once joined, rather than evidence that Mesosaurus crossed the ocean by some other means.`, solution: `The fossil pattern is evidence that South America and southern Africa were once joined, or close enough together for Mesosaurus to move between them without crossing open ocean, because a freshwater animal too weak to survive that ocean crossing has no other way of reaching both continents.` },
      relatedLoIds: ['m6sci.evidence-for-continental-drift'],
    },
    {
      title: 'Worked seafloor and the missing mechanism',
      steps: [
      ...
      example: { problem: `Scientists mapping the floor of the Atlantic Ocean near the Mid-Atlantic Ridge find that the pattern of magnetic stripes recorded in the rock is a mirror image: the same sequence of stripes appears on the ridge's western side and again, in reverse order, on its eastern side. Explain what that mirrored pattern shows, and why this particular evidence succeeded in convincing scientists that continents move, when Wegener's original coastline, fossil, and rock-layer evidence had not been enough.`, solution: `The mirrored stripe pattern shows that new ocean floor forms at the ridge and spreads outward on both sides over time, so the ocean floor itself moves. That succeeded in convincing scientists because it gave them something Wegener never had: direct, measurable evidence that the seafloor is created and in motion, rather than only evidence that continents once fit together.` },
      relatedLoIds: ['m6sci.evidence-for-continental-drift'],
    },
  ],
  pointers: [
    { content: `Students often say "Wegener's idea was rejected because his evidence was wrong." — Wegener's coastline, fossil, and rock-layer evidence held up over time and was never shown to be false. What got continental drift rejected for decades was that Wegener could not explain a believable physical cause for the motion -- what could possibly move something as massive as a continent -- and the causes he did guess at, such as tidal forces, were shown by calculation to be far too weak. The evidence was solid; the explanation of the cause was missing.`, kind: 'common-error' },
    { content: `Students often say "The matching magnetic stripes just mean both sides of the ocean formed at exactly the same time." — The mirror-image pattern means rock at the same distance from the ridge, on either side, formed at the same time and carries the same magnetic record -- not that the whole ocean floor formed at once. Rock right at the ridge is the youngest; rock farther from the ridge, on either side, is progressively older, because new rock keeps forming at the ridge and spreads outward over a very long span of time.`, kind: 'common-error' },
    { content: `Wegener proposed in 1912 that the continents were once joined in a single landmass, which he called Pangaea, and have since drifted apart.`, kind: 'tip' },
    { content: `Matching coastline shapes, such as the fit between South America and Africa, were one of his first clues.`, kind: 'tip' },
    { content: `Matching fossils -- Mesosaurus, Glossopteris, Lystrosaurus, and Cynognathus -- found on continents an ocean now separates, in organisms that could not have crossed that ocean on their own, are strong evidence the continents were once joined.`, kind: 'tip' },
    { content: `Matching sequences of rock layers, in the same order and of the same age, found on separated continents point to the same conclusion.`, kind: 'tip' },
    { content: `Wegener's evidence held up. What got his proposal rejected for decades was that he could not explain a plausible physical cause for continental motion, and the causes he guessed at, such as tidal forces, were shown to be far too weak.`, kind: 'tip' },
    { content: `Decades later, scientists mapping the ocean floor found mirror-image magnetic stripe patterns on either side of mid-ocean ridges, showing that new ocean floor forms at the ridge and spreads outward over time.`, kind: 'tip' },
    { content: `That seafloor evidence, discovered after Wegener died in 1930, is what finally persuaded scientists that continents really do move.`, kind: 'tip' },
    { content: `Four different kinds of evidence -- coastlines, fossils, rock layers, and the seafloor's magnetic pattern -- together made a case no single line of evidence could have made alone.`, kind: 'tip' },
  ],
};
