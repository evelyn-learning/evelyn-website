/**
 * Grade 8 English Language Arts — Unit 5 CED 5.4: Verb Moods.
 *
 * Auto-extracted from the corresponding lesson plan
 * (evelyn.ms.m8ela.verb-moods.v1). Hand-edit freely after extraction; bump
  ...
  methods: [
    {
      ...
      example: { problem: `Name the mood of each sentence, and say how you know. All five come from a note a neighbor left on the counter before a trip.
...
(5) "I wish he were calmer around the mail carrier."`, solution: `Sentence 1 is indicative: it states a fact, with the subject in front of the verb and no other shape present. Sentence 2 is imperative: it starts with the plain verb "Fill" and the subject "you" is understood. Sentence 3 is interrogative: it asks for an answer, with the helper "Do" in front of the subject. Sentence 4 is conditional: the verb is "would stay", and the result depends on a longer leash that the dog does not have. Sentence 5 is subjunctive: "were" follows "I wish", which is the shape a wish takes in formal writing.` },
      relatedLoIds: ['m8ela.verb-moods'],
    },
    {
      title: 'Worked three pairs that look alike',
      steps: [
      ...
      example: { problem: `Each pair below looks like one mood and splits into two. Name the mood of both sentences in each pair, and say exactly what decides it.
...
PAIR C: "The science fair was on a Saturday last year, and almost nobody came." / "I wish the science fair were on a Saturday this year."`, solution: `Pair A: the first sentence is indicative, because its result verb "will move" states a plan, and the second is conditional, because "could move" supposes one; the shared "if" decides nothing. Pair B: the first is imperative, because "email" is the plain shape with the subject "you" understood and Priya spoken to, and the second is indicative, because "Priya" is the subject and the verb has taken its -s. Pair C: the first is indicative, because "was" states what happened last year, and the second is subjunctive, because "were" follows "I wish" about something that is not so.` },
      relatedLoIds: ['m8ela.verb-moods'],
    },
  ],
  pointers: [
    { content: `Students often say "Sentence 1 is conditional, because it starts with "if"." — Look at the verbs instead. The sentence has "are" and "will back up", and neither one is would, could, might or should plus a plain verb. So the sentence is INDICATIVE: it states what is going to happen, with a condition attached to it. To make it conditional you have to change the result verb, not the opening: "If the tables are still in the shed at nine, the line of cars could back up onto the street." Now the mood has changed, and the word "if" has not moved. Run it the other way too: "With two more buckets, the line could move twice as fast" is conditional and carries no "if" at all.`, kind: 'common-error' },
    { content: `Students often say "Sentence 2 is subjunctive, because it is a wish." — The verb in that sentence is "was", which is the indicative form. In a wish, formal writing uses "were" for every subject, singular ones included. So as printed, the sentence states its wish in the indicative form, and the label follows the form on the page. WRONG, in formal writing: "I wish the second hose was longer." CORRECT: "I wish the second hose were longer." Now the form matches the job, and the sentence is subjunctive. You will hear people say it both ways out loud, which is exactly why the label comes from the form and not from the feeling.`, kind: 'common-error' },
    { content: `Tense answers WHEN. Mood answers WHAT KIND of statement the verb form is making: stating, telling somebody to act, asking, supposing, or wishing. This grammar word has nothing to do with the mood a story puts you in.`, kind: 'tip' },
    { content: `Check in an order: is it asking (interrogative), does it start with a plain verb and no subject (imperative), does the main verb carry would, could, might or should (conditional), does it carry "were" after a wish or a base form in a that-clause (subjunctive), and if all four answers are no, it is indicative.`, kind: 'tip' },
    { content: `The indicative states something as a fact, and it is the default. "Will" plus a verb is still indicative, because a plain statement about the future is still a statement.`, kind: 'tip' },
    { content: `The imperative tells somebody to do something, with the verb in its plain shape and the subject "you" understood. "Fill the water bowl before you leave for school." A name in front, a "please" inside, or a period at the end changes nothing.`, kind: 'tip' },
    { content: `The conditional is would, could, might or should plus the plain verb, and "if" is not the test. A sentence with no "if" in it can be conditional, and a sentence that opens with "if" is indicative when its result verb only states a plan.`, kind: 'tip' },
    { content: `The subjunctive has two shapes: "were" for every subject after a wish or an untrue "if", and the plain base form in a that-clause after ask, suggest, insist, recommend or require. WRONG, in formal writing: "I wish the science fair was on a Saturday." CORRECT: "I wish the science fair were on a Saturday."`, kind: 'tip' },
  ],
};
