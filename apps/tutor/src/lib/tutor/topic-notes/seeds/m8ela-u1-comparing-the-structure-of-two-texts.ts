/**
 * Grade 8 English Language Arts — Unit 1 CED 1.4: Comparing the Structure of Two Texts.
 *
 * Auto-extracted from the corresponding lesson plan
 * (evelyn.ms.m8ela.comparing-the-structure-of-two-texts.v1). Hand-edit freely after extraction; bump
...
export const BASELINE_M8ELA_U1_COMPARING_THE_STRUCTURE_OF_TWO_TEXTS: TopicNotesBaseline = {
  baselineId: 'evelyn.ms.m8ela.comparing-the-structure-of-two-texts.v1',
  course: 'Grade 8 English Language Arts',
  cedUnit: 1,
  cedTopic: '1.4',
  cedTitle: 'Comparing the Structure of Two Texts',
  planId: 'evelyn.ms.m8ela.comparing-the-structure-of-two-texts.v1',
  baselineVersion: 1,
  lastUpdatedAt: '2026-09-20',
  sources: [{ type: 'plan', planId: 'evelyn.ms.m8ela.comparing-the-structure-of-two-texts.v1' }],
  theory: [
    { loId: 'm8ela.comparing-the-structure-of-two-texts', content: `STRUCTURE IS THE PATH THE READER TAKES, NOT THE EVENTS ON IT. Two texts can hold the same events, the same people and the same ending and still be built differently. Structure is the order the pieces arrive in and the shape that holds them: a paragraph that runs straight through, a paragraph that opens at the ending and looks back, a stanza that sets each picture on its own line. When you compare two structures you are comparing paths, not contents. "Text B mentions the coach and Text A does not" is a difference in content. "Text B tells you the result before it tells you the tryout" is a difference in structure.` },
    { loId: 'm8ela.comparing-the-structure-of-two-texts', content: `FIND A TEXT'S STRUCTURE BY ASKING WHAT THE READER GETS FIRST AND WHAT IS HELD BACK. A CHRONOLOGICAL text gives events in the order they happened, so the reader finds out how things turn out at the same moment the character does. An OUTCOME-FIRST text opens with how things turned out and then looks back at how they got there, so the reader carries the ending into every earlier sentence. Run the question on both texts before you compare them: what do I know after the first sentence, and what am I still waiting for?` },
    { loId: 'm8ela.comparing-the-structure-of-two-texts', content: `THE SAME SENTENCE READS DIFFERENTLY DEPENDING ON WHAT THE READER ALREADY KNOWS. That is the mechanism, and it is worth saying slowly. In a chronological text, a boy checking his project folder twice reads as care, and the reader hopes with him. In an outcome-first text that has already shown the empty file, the same checking reads as effort that was never going to be enough. The sentence did not change. The reader's knowledge did, and the structure is what changed the knowledge. So chronological order tends to build toward a result and let it land as a surprise or a relief, while outcome-first order takes the surprise away and puts something else in its place, often regret, often a sense that the ending was coming all along.` },
    { loId: 'm8ela.comparing-the-structure-of-two-texts', content: `A PARAGRAPH CONNECTS; A STANZA SEPARATES. Prose runs its details together with linking words such as "and", "so", "while" and "because", and it usually tells the reader why. A short free-verse stanza takes the same subject and breaks it into lines, drops most of the linking words, and lets each line hold one picture and stop. The order of the pictures may be identical to the paragraph's, and the structure is still different, because the shape is different. That shape does two things: it slows the reader down, since each line asks to be taken on its own, and it hands the connecting work to the reader, who has to supply the "so" and the "because" that the poem left out.` },
    { loId: 'm8ela.comparing-the-structure-of-two-texts', content: `A COMPARISON NAMES THE DIFFERENCE; AN EXPLANATION NAMES WHAT THE DIFFERENCE DOES. It is not enough to say that Text A is chronological and Text B opens at the ending, or that Text A is a paragraph and Text B is a stanza. The question is what the differing structure changes, and there are two things it can change. MEANING: what the events add up to, which is why the same walk home can mean defeat in one text and patience in the other. STYLE: how the text feels and moves, which is why the same bus stop can feel easygoing in a sentence full of "because" and spare and slow in four short lines. Say the difference, then say the change, and tie the change to something the reader knows or does at a specific point in the text.` },
    { loId: 'm8ela.comparing-the-structure-of-two-texts', content: `THE TRAP IS COMPARING WORDS INSTEAD OF STRUCTURE. When two texts share their events, the eye goes to the details one has and the other lacks, or to which one has the better words. Those are real differences, and they are not structural. Test any difference you find with one question: is this about the ORDER the pieces arrive in or the SHAPE that holds them? If the answer is no, set it aside. If the answer is yes, you have found structure, and the next job is to say what it does.` },
    { loId: 'm8ela.comparing-the-structure-of-two-texts', kind: 'definition', title: 'structure', content: `the order in which a text's pieces arrive and the shape that holds them; the path the reader takes through the events, as distinct from the events themselves.` },
    { loId: 'm8ela.comparing-the-structure-of-two-texts', kind: 'definition', title: 'chronological order', content: `a structure that gives events in the order they happened, so the reader learns the outcome at the same moment the character does.` },
    { loId: 'm8ela.comparing-the-structure-of-two-texts', kind: 'definition', title: 'outcome-first order', content: `a structure that opens with how things turned out and then looks back at how they got there, so the reader carries the ending into every earlier sentence.` },
    { loId: 'm8ela.comparing-the-structure-of-two-texts', kind: 'definition', title: 'stanza', content: `a group of lines in a poem, set off by space from the lines around it; the unit of shape in a poem, the way the paragraph is in prose.` },
    { loId: 'm8ela.comparing-the-structure-of-two-texts', kind: 'definition', title: 'free verse', content: `poetry that does not follow a set rhyme pattern or beat; its shape comes from its lines and its stanzas.` },
  ],
  methods: [
    {
      title: 'Worked same events two orders',
      steps: [
      ...
      example: { problem: `Both texts tell the same events. Name each text's structure, then explain how the difference changes the meaning of the rehearsing.
...
TEXT B: "For three long seconds on opening night, Nadia stood in the light and said nothing. She had run her lines on the bus, again in the hallway, and one last time in the wings. None of it had mattered."`, solution: `Text A is chronological: rehearsing, then the lights, then the blank, so the reader hopes with Nadia and is caught by "The second word did not come at all." Text B is outcome-first: it opens on Nadia standing "in the light" saying nothing and then looks back, so the same rehearsing reads as effort the reader already knows was wasted, and the shock of Text A becomes the regret of Text B.` },
      relatedLoIds: ['m8ela.comparing-the-structure-of-two-texts'],
    },
    {
      title: 'Worked paragraph vs stanza',
      steps: [
      ...
      example: { problem: `Both texts describe the same afternoon. Compare their structures and explain what the difference does to the style and the meaning.
...
Nobody wanted to be the first to leave."`, solution: `Text A is a single paragraph that links every detail with "and", "while" and "because" and tells the reader why the group stayed; Text B is a stanza that sets each picture on its own line with no linking words and no reason given. The stanza is slower and sparer in style, and because it ends on the line about not leaving, its meaning shifts from what happened that afternoon to the feeling of not wanting it to end.` },
      relatedLoIds: ['m8ela.comparing-the-structure-of-two-texts'],
    },
  ],
  pointers: [
    { content: `Students often say "Same structure. Both go second inning, then fourth, then the umpire, so the only difference is that Text B has fewer words." — The order is the same in both texts, and the structures are still different, because a paragraph and a stanza are different shapes. Text A ties its three pieces together with "and" and "so" and moves the reader straight through to the decision. Text B puts each piece on its own line and stops after each one, with no linking word anywhere. That changes the reader's path even though it does not change the sequence: the reader slows down at every line and does the connecting that Text A did for them. Fewer words is the least of it. The shape is part of the structure, and the shape changed.`, kind: 'common-error' },
    { content: `Students often say "Text B has no structure at all. It is three pieces with the connections missing, so the umpire's decision has no cause in Text B and the meaning Text A had is gone." — Dropping the "so" is the stanza's structural choice, not the absence of one. The cause of the decision is still there, carried by the order of the lines: rain, then a pond, then "The umpire's arm went up." What Text B has done is hand the reader the job of supplying the "so", and that is exactly the change in style and meaning you are asked to name. Text A explains the decision; Text B makes you watch it happen one line at a time and work out for yourself why the arm went up. The meaning has not gone anywhere. It has moved from the page to the reader.`, kind: 'common-error' },
    { content: `Structure is the path the reader takes through a text: the order the pieces arrive in and the shape that holds them. It is not the events, the people or the ending, which two differently built texts can share completely.`, kind: 'tip' },
    { content: `Find a structure by asking what the reader gets first and what is held back. Chronological order gives events as they happened; outcome-first order gives the ending and then looks back.`, kind: 'tip' },
    { content: `The same sentence reads differently depending on what the reader already knows. Chronological order lets a result land as a surprise or a relief; outcome-first order takes the surprise away and turns earlier details into signs of what was coming.`, kind: 'tip' },
    { content: `A paragraph connects with "and", "so" and "because" and tells you why; a stanza sets each picture on its own line, drops the links, and makes the reader slow down and supply the why. Same order, different shape, still a different structure.`, kind: 'tip' },
    { content: `A comparison names the difference; an explanation names what the difference changes, in meaning (what the events add up to) or in style (how the text feels and moves). Tie the change to a specific point where the reader knows or does something different.`, kind: 'tip' },
    { content: `A detail one text has and the other lacks, or better words in one than in the other, is a difference in content or word choice, not in structure. Ask whether a difference is about order or about shape before you call it structural.`, kind: 'tip' },
  ],
};
