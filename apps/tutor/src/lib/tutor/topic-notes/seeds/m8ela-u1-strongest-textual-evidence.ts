/**
 * Grade 8 English Language Arts — Unit 1 CED 1.1: Strongest Textual Evidence.
 *
 * Auto-extracted from the corresponding lesson plan
 * (evelyn.ms.m8ela.strongest-textual-evidence.v1). Hand-edit freely after extraction; bump
...
export const BASELINE_M8ELA_U1_STRONGEST_TEXTUAL_EVIDENCE: TopicNotesBaseline = {
  baselineId: 'evelyn.ms.m8ela.strongest-textual-evidence.v1',
  course: 'Grade 8 English Language Arts',
  cedUnit: 1,
  cedTopic: '1.1',
  cedTitle: 'Strongest Textual Evidence',
  planId: 'evelyn.ms.m8ela.strongest-textual-evidence.v1',
  baselineVersion: 1,
  lastUpdatedAt: '2026-09-20',
  sources: [{ type: 'plan', planId: 'evelyn.ms.m8ela.strongest-textual-evidence.v1' }],
  theory: [
    { loId: 'm8ela.strongest-textual-evidence', content: `ALL EVIDENCE PASSES THE SAME GATE; NOT ALL EVIDENCE IS EQUAL. You already know the gate: a detail counts only if it is really on the page and really about the claim, with no guesses and no mismatched quotes. Today every detail you look at has already passed it. Two true, on-topic details can still be miles apart in how hard they push the claim. "She looked at the floor" and "she slid the trophy behind the books before her sister came in" both fit the claim that she is jealous of her sister. Only one of them makes you say it.` },
    { loId: 'm8ela.strongest-textual-evidence', content: `UNDERLINE THE DEMANDING WORD IN THE CLAIM. Every claim has one word or phrase that does the real work: jealous, not just upset; lying, not just nervous; planned, not just happened. Weak evidence reaches the neighborhood of that word; strong evidence reaches the word itself. Read the claim first and know exactly what has to be proven before you look at a single detail. A claim with two halves, such as "disappointed, and hiding it," is strongest served by a detail that reaches both.` },
    { loId: 'm8ela.strongest-textual-evidence', content: `THE OTHER-STORIES TEST: STRONG EVIDENCE FITS THE CLAIM AND ALMOST NOTHING ELSE. For each detail, ask how many other stories it fits just as well. "She looked at the floor" fits shy, tired, guilty, bored and jealous: five stories, so it barely moves the claim. The hidden trophy fits jealousy and very little else. The fewer other stories a detail fits, the stronger it is. This one question is the whole ranking.` },
    { loId: 'm8ela.strongest-textual-evidence', content: `CONSISTENT IS NOT THE SAME AS SUPPORTING. A detail that does not contradict the claim can still do nothing for it. "The gym was crowded" is consistent with "Marcus was nervous" and is not evidence for it. The bottom of every ranking is full of details like this: true, on the page, and proving nothing. Do not mistake "it fits" for "it shows."` },
    { loId: 'm8ela.strongest-textual-evidence', content: `VIVID IS NOT THE SAME AS STRONG. The line that stands out most, the slammed door, the shout, the tears, is often the one that fits the most other stories, because big feelings have many causes. Rank a detail by what it proves, not by how much you noticed it. The strongest detail is often a small, quiet one that nobody in the story meant for anyone to see.` },
    { loId: 'm8ela.strongest-textual-evidence', content: `THE ONE-QUOTE TEST DECIDES A TIE. When two details both look strong, imagine you may quote only one, and the claim has to stand on it alone. The one that leaves the claim standing is the one you cite. That is what "cite the evidence that supports best" means: not the first detail you found, not all of them, but the one that does the most work.` },
    { loId: 'm8ela.strongest-textual-evidence', kind: 'definition', title: 'strongest evidence', content: `among several details that all support a claim, the one that reaches the claim's demanding word most directly and fits the fewest other stories.` },
    { loId: 'm8ela.strongest-textual-evidence', kind: 'definition', title: 'consistent with', content: `a detail that does not contradict a claim but does not push it either; being consistent is not the same as supporting.` },
    { loId: 'm8ela.strongest-textual-evidence', kind: 'definition', title: 'the other-stories test', content: `asking how many different explanations a detail fits just as well as it fits the claim; the fewer, the stronger the evidence.` },
    { loId: 'm8ela.strongest-textual-evidence', kind: 'definition', title: 'demanding word', content: `the word or phrase in a claim that does the real work and has to be proven (jealous, lying, planned), as opposed to its milder neighbors.` },
    { loId: 'm8ela.strongest-textual-evidence', kind: 'definition', title: 'rank', content: `to put several true details in order from the one that supports the claim best to the one that barely supports it at all.` },
  ],
  methods: [
    {
      title: 'Worked rank four true details',
      steps: [
      ...
      example: { problem: `Claim: "Nadia is more disappointed about the list than she is letting anyone see." Four details from the excerpt are listed below it. Rank them from strongest to weakest, and say which one you would cite.
...
Detail 4: "the kneepads Nadia had bought with her own money in July at the bottom of the kitchen trash, still in the package"`, solution: `Strongest: the kneepads Nadia "had bought with her own money in July," found "at the bottom of the kitchen trash, still in the package," because that one detail reaches both halves of the claim, real disappointment and hiding it, and fits no other story. Then the laugh and the denial to Priya, which shows the hiding but leaves the disappointment open. Then "fine" and the window, which fits the claim but fits tired or annoyed just as well. Weakest, "read it twice," which fits at least four stories and proves none of them.` },
    ...
    },
    {
      ...
      example: { problem: `The same ranking works on nonfiction. Claim: "The robot could not be counted on during matches." Rank the four details below and say which one you would cite.
...
Detail 4: "In four of its nine matches the robot stopped moving before the round ended"`, solution: `Strongest: "In four of its nine matches the robot stopped moving before the round ended," because a robot that stops mid-match that often is exactly what "could not be counted on during matches" means, and no other story fits it. Second: the arm "rebuilt three times," which fits breakdowns but fits upgrades just as well. The placing and the spare battery are at the bottom in either order; both are consistent with the claim, and neither is evidence for it.` },
      relatedLoIds: ['m8ela.strongest-textual-evidence'],
    },
  ],
  pointers: [
    { content: `Students often say "The strongest evidence is that Ava "groaned loudly enough for the whole house to hear," because it is the biggest moment in the passage." — Run the other-stories test. A loud groan fits a girl who is faking, and it fits a girl who really does have a fever, exactly as well; it does not make you say either one. Big moments usually have many causes, which is why they so often sit near the bottom of a ranking. The detail that fits almost no other story is a quiet one: "by ten fifteen she was on the bus to the mall with her skateboard under her arm." A skateboard at the mall at ten fifteen fits no story in which she is sick in bed, and that is what makes it the strongest.`, kind: 'common-error' },
    { content: `Students often say "The strongest evidence is that "The thermometer sat on the kitchen counter, unused," because it fits the claim." — Underline the demanding words, "not really sick," and ask which detail reaches them. An unused thermometer fits a girl who is faking, but it fits a mother who never thought to check, or a house where nobody uses that thermometer, just as easily; it is consistent with the claim and does almost nothing for it. The skateboard at the mall reaches the demanding words; the thermometer only sits near them. Cite the detail that reaches the word, not the one that merely fails to contradict it.`, kind: 'common-error' },
    { content: `Every detail you rank has already passed the gate: it is really on the page and really about the claim. Ranking starts where citing ended.`, kind: 'tip' },
    { content: `Underline the demanding word in the claim first. Strong evidence reaches that word; weak evidence reaches only the neighborhood.`, kind: 'tip' },
    { content: `The other-stories test: the fewer other stories a detail fits, the stronger it is. A detail that fits five stories barely moves the claim.`, kind: 'tip' },
