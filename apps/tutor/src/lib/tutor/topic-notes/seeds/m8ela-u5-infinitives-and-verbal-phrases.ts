/**
 * Grade 8 English Language Arts — Unit 5 CED 5.2: Infinitives & Verbal Phrases.
 *
 * Auto-extracted from the corresponding lesson plan
 * (evelyn.ms.m8ela.infinitives-and-verbal-phrases.v1). Hand-edit freely after extraction; bump
  ...
  methods: [
    {
      ...
      example: { problem: `Name the job each infinitive phrase does — noun, adjective, or adverb — and say how you know.
...
(4) "He walked to the studio with the sticks in his back pocket."`, solution: `Sentence 1: "To learn the whole drum part" does a noun's job, sitting in the subject seat as the thing that took three weekends. Sentence 2: "to practice the hardest fill" does an adjective's job, telling which place he wanted. Sentence 3: "to record the last take" does an adverb's job, telling why he stayed after school. Sentence 4 has no infinitive; "to the studio" is a prepositional phrase telling where he walked.` },
    ...
    },
    {
      ...
      example: { problem: `Find the complete verbal phrase in each sentence and name the one job it does.
...
(C) "Nadia raised her hand to ask about the second verse."`, solution: `A: the phrase is "Painting the set flats for the spring musical", and it does a noun's job as the subject, naming what took four afternoons. B: the phrase is "taped to the band room door", and it does an adjective's job, telling which list. C: the phrase is "to ask about the second verse", and it does an adverb's job, telling why Nadia raised her hand.` },
      relatedLoIds: ['m8ela.infinitives-and-verbal-phrases'],
    },
  ],
  pointers: [
    { content: `Students often say "The infinitive phrase in "Amir ran to the corner store for a bag of ice" is "to the corner store"." — Ask what follows "to". The next word is "the", and after that "corner store", a thing you can put "the" in front of. So "to" is working as a little location word here, exactly the way "under" or "behind" would, and "to the corner store" is a prepositional phrase telling where Amir ran. An infinitive needs the plain form of an action verb right after "to", as in "to buy". This sentence contains no infinitive at all; the verb that runs it is "ran".`, kind: 'common-error' },
    { content: `Students often say "The verbal phrase in "The posters stacked near the door still needed staples" is "stacked", and it is doing a noun's job." — Take the whole phrase first. Start at "stacked", keep the words that answer to it, "near the door", and stop before "still needed staples", because "needed" is the verb that runs the sentence. The phrase is "stacked near the door". Now ask what it does. It does not name a thing; the sentence already has its subject, "The posters". It tells the reader which posters are meant, so it is doing an adjective's job. The ending of the verbal never decides the job, and a single word is almost never the whole phrase.`, kind: 'common-error' },
    { content: `An infinitive is "to" plus the plain form of a verb ("to swim", "to finish"), and it is never the verb that runs the sentence. Find that verb first, so you know what is left over.`, kind: 'tip' },
    { content: `Check the word right after "to". A plain verb makes an infinitive; a thing you could put "the" in front of makes a prepositional phrase. WRONG: "The infinitive is 'to the far end'." CORRECT: "'To the far end' tells where; 'to jog' would be the infinitive."`, kind: 'tip' },
    { content: `An infinitive does one of three jobs, and you ask in this order: does it name a thing (noun), describe the noun in front of it (adjective), or tell why about the verb (adverb)?`, kind: 'tip' },
    { content: `A verbal phrase is the verbal plus its object and its modifiers, and the whole package does one job. WRONG: "The verbal phrase is 'waiting'." CORRECT: "The verbal phrase is 'waiting outside the band room'."`, kind: 'tip' },
    { content: `The phrase stops where the sentence's own subject-verb pair begins. A verbal phrase never contains the verb that runs the sentence, because a phrase has no subject-verb pair of its own.`, kind: 'tip' },
    { content: `Name the job from what the whole phrase does in this sentence, never from how the verbal ends. The same -ing word can head a phrase doing a noun's job in one sentence and an adjective's job in another.`, kind: 'tip' },
    { content: `Don't confuse "to" the infinitive marker with "to" the location word. After "to", if you can put "the" in front of the next word, it's a place or person (prepositional phrase), not an infinitive. "To the gym" = prepositional phrase. "To run" = infinitive.`, kind: 'common-error' },
    { content: `Always include the object and modifiers when you name a verbal phrase—never stop at just the verbal word. "Waiting" alone is a half-phrase error. The whole phrase is "waiting outside the band room", and only the whole thing has a job.`, kind: 'gotcha' },
    { content: `Find the main sentence's subject-verb pair first. That tells you where the phrase ends. A phrase stops before the verb that runs the sentence—it never includes that verb. If your phrase contains "heard" or "took" or "wanted", you've grabbed too much.`, kind: 'tip' },
    { content: `The shape of the verbal (to, -ing, -ed) tells you nothing about the job. An -ing word can head a noun phrase in one sentence and an adjective phrase in another. Always ask: does it name a thing, describe the noun in front, or tell why about the verb?`, kind: 'vocab-note' },
    { content: `When naming a phrase's job, test it with a swap: replace the phrase with a simple noun (for noun job), check if it describes the noun right before it (for adjective job), or ask "why?" about the main verb (for adverb job). Only one question will fit cleanly.`, kind: 'tip' },
    { content: `Watch for sentences where the infinitive phrase sits in the subject seat, right before the main verb. "To finish the whole level" in "To finish the whole level took two hours" is doing a noun's job because it names what took the time.`, kind: 'edge-case' },
    { content: `If the noun right before an infinitive phrase is a person or thing (not an action), the infinitive probably describes it (adjective job). "Bring a bucket to fill" — "to fill" describes which bucket. If there's no noun right before it, it's probably telling why (adverb job).`, kind: 'tip' },
  ],
};
