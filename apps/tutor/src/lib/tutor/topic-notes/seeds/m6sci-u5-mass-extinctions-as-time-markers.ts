/**
 * Grade 6 Science — Unit 5 CED 5.4: Mass Extinctions as Time Markers.
 *
 * Auto-extracted from the corresponding lesson plan
 * (evelyn.ms.m6sci.mass-extinctions-as-time-markers.v1). Hand-edit freely after extraction; bump
...
export const BASELINE_M6SCI_U5_MASS_EXTINCTIONS_AS_TIME_MARKERS: TopicNotesBaseline = {
  ...
  methods: [
    ...
    },
    {
      ...
      example: { problem: `A single, undisturbed rock sequence in one location happens to preserve two separate mass-extinction boundaries. A geologist reports that both boundaries sit below the layer marking the end of the Paleozoic Era, and that both are less severe than the end-Permian boundary. Name the two boundaries, list them from lower (older) to upper (younger), and state about how many million years apart they are.`, solution: `The lower, older boundary is end-Ordovician, about 440 million years ago. The upper, younger boundary is end-Devonian, about 360 million years ago. They are separated by roughly 80 million years (440 minus 360 equals 80).` },
      relatedLoIds: ['m6sci.mass-extinctions-as-time-markers'],
    },
  ],
  pointers: [
    { content: `Students often say "It happened exactly 250 million years ago because paleontologists counted how many species disappeared there." — An age in years for a boundary comes from radiometric dating of the rock itself, the method from an earlier lesson, not from counting how many fossil types vanished. How many fossil types disappear at a boundary is a measure of how SEVERE that extinction was; it has nothing to do with how the boundary's age in years was measured.`, kind: 'common-error' },
    { content: `Students often say "Since it was the biggest extinction of the five, it must be the boundary between the Mesozoic Era and the Cenozoic Era." — The end-Permian boundary, the most severe of the five, marks the boundary between the Paleozoic Era and the Mesozoic Era. The boundary between the Mesozoic Era and the Cenozoic Era is a different, later event -- the end-Cretaceous boundary, about 66 million years ago -- which is less severe than end-Permian even though it is the more familiar of the two.`, kind: 'common-error' },
    { content: `A mass-extinction boundary is a sudden, worldwide change in which fossil types appear in the rock record, and that abrupt change is what makes it useful as a time marker.`, kind: 'tip' },
    { content: `The five major boundaries, oldest to youngest: end-Ordovician (about 440 million years ago), end-Devonian (about 360 million years ago), end-Permian (about 250 million years ago, the most severe of the five), end-Triassic (about 200 million years ago), and end-Cretaceous, also called the K-Pg boundary (about 66 million years ago).`, kind: 'tip' },
    { content: `These five boundaries divide the Phanerozoic eon into its eras and periods. End-Permian and end-Cretaceous mark ERA boundaries. End-Ordovician, end-Devonian and end-Triassic mark PERIOD boundaries inside a single era.`, kind: 'tip' },
    { content: `A boundary's severity and what kind of division it marks are two separate facts. Neither one tells you the other.`, kind: 'tip' },
