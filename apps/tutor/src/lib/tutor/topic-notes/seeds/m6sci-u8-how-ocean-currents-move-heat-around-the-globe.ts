/**
 * Grade 6 Science — Unit 8 CED 8.3: How Ocean Currents Move Heat Around the Globe.
 *
 * Auto-extracted from the corresponding lesson plan
 * (evelyn.ms.m6sci.how-ocean-currents-move-heat-around-the-globe.v1). Hand-edit freely after extraction; bump
...
export const BASELINE_M6SCI_U8_HOW_OCEAN_CURRENTS_MOVE_HEAT_AROUND_THE_GLOBE: TopicNotesBaseline = {
  ...
  theory: [
    ...
    { loId: 'm6sci.how-ocean-currents-move-heat-around-the-globe', content: `THE OCEAN NEXT TO A COASTLINE IS PART OF THAT COASTLINE'S CLIMATE. Warmer offshore water keeps the nearby air milder than the coastline's latitude alone would predict. Colder offshore water keeps the nearby air cooler than the coastline's latitude alone would predict. A current is what is moving the warmth or the cold from where it started to that stretch of coast; exactly how the warmth passes from the water into the air above it is not covered here -- that mechanism belongs to a later grade.` },
    { loId: 'm6sci.how-ocean-currents-move-heat-around-the-globe', content: `TWO NAMED EXAMPLES. The Gulf Stream starts in warm water near the Gulf of Mexico and the Straits of Florida, flows north along the United States coast, then bends east across the North Atlantic Ocean as the North Atlantic Current, reaching the coast of northwestern Europe. That warm current is a major reason winters in places like the United Kingdom and Norway are far milder than most places at the same latitude. The Labrador Current starts in cold water near the Arctic and Baffin Bay and flows south along the coast of Newfoundland and Labrador, in eastern Canada -- keeping that stretch of coast colder and foggier than its latitude alone would suggest, even though it sits at roughly the same latitude as the mild United Kingdom coast.` },
    { loId: 'm6sci.how-ocean-currents-move-heat-around-the-globe', content: `A CURRENT'S EFFECT STACKS ON TOP OF LATITUDE, ELEVATION AND DISTANCE FROM WATER. The previous lesson covered the GENERAL factors that set a region's typical climate. A current does not replace those factors -- it adds an extra push on top of them, warmer or cooler, depending on which kind of current, if any, runs along that coastline. That is exactly why two coastlines at nearly the same latitude, like San Diego and Charleston, or Newfoundland and the United Kingdom, can end up with such different climates.` },
    { loId: 'm6sci.how-ocean-currents-move-heat-around-the-globe', kind: 'definition', title: 'surface current', content: `a stream of ocean water at or near the surface that flows along a fairly fixed, repeating path.` },
    { loId: 'm6sci.how-ocean-currents-move-heat-around-the-globe', kind: 'definition', title: 'warm current', content: `a surface current carrying water that is warmer than the ocean water it is currently flowing through.` },
    { loId: 'm6sci.how-ocean-currents-move-heat-around-the-globe', kind: 'definition', title: 'cold current', content: `a surface current carrying water that is colder than the ocean water it is currently flowing through.` },
    { loId: 'm6sci.how-ocean-currents-move-heat-around-the-globe', kind: 'definition', title: 'moderate', content: `to make a place's temperature extremes less severe -- for example, milder winters, cooler summers, or both.` },
  ],
  methods: [
    {
      title: 'Worked gulf stream to Europe',
      steps: [
      ...
      example: { problem: `The Gulf Stream starts in warm water near the Gulf of Mexico and the Straits of Florida, flows north along the United States East Coast, then bends east across the North Atlantic Ocean toward the coast of northwestern Europe. In the Straits of Florida, instruments show the current moving at about 2 meters every second. Trace what this current does to the climate of northwestern Europe, and work out about how many kilometers per hour that is.`, solution: `The Gulf Stream carries warm water from the Gulf of Mexico north and then east to northwestern Europe, keeping that coastline's winters far milder than its latitude alone would predict. In the Straits of Florida the current moves at about 2 meters per second, which works out to about 7.2 kilometers per hour (2 m/s x 60 s/min = 120 m/min; 120 m/min x 60 min/hr = 7,200 m/hr; 7,200 m/hr / 1,000 = 7.2 km/hr).` },
      relatedLoIds: ['m6sci.how-ocean-currents-move-heat-around-the-globe'],
    },
    {
      title: 'Worked labrador current contrast',
      steps: [
      ...
      example: { problem: `Not far from where the Gulf Stream reaches the North Atlantic, the Labrador Current starts in cold water near the Arctic and Baffin Bay and flows south along the coast of Newfoundland and Labrador, in eastern Canada. A student claims: "Newfoundland is not much farther north than the United Kingdom, so its winter coastal climate should be about as mild." Evaluate that claim using the current's origin and direction.`, solution: `The claim is wrong. The United Kingdom sits along the path of the warm Gulf Stream and North Atlantic Current, which pushes its winter climate milder than its latitude predicts. Newfoundland and Labrador sit along the path of the cold Labrador Current instead, which pushes their winter climate cooler and foggier than their similar latitude would otherwise suggest. Similar latitude, very different current, very different climate.` },
      relatedLoIds: ['m6sci.how-ocean-currents-move-heat-around-the-globe'],
    },
  ],
  pointers: [
    { content: `Students often say "Currents only change the temperature of the water, not the climate people experience on land." — The ocean water next to a coastline is part of that coastline's climate. When a current makes the nearby water warmer or colder than the coastline's latitude alone would predict, the air above that water is pushed warmer or cooler along with it, and that is what people on the coast actually experience. This is why coastal Norway and the United Kingdom, sitting along the warm Gulf Stream and North Atlantic Current, have far milder winters than most places at their latitude.`, kind: 'common-error' },
    { content: `Students often say "A warm current is warm no matter where it travels." — A current is classified warm or cold by comparing its water to the surrounding ocean at that latitude, not by a fixed temperature. A current carrying water that started near the tropics is still called a warm current far from the tropics, as long as it stays warmer than the colder water around it there -- even though, by that point, the water itself might feel far too cold to swim in comfortably.`, kind: 'common-error' },
    { content: `A surface current is a wide band of ocean water that follows a fixed, repeating path -- some starting near the tropics, some starting near the poles.`, kind: 'tip' },
    { content: `Warm and cold are a COMPARISON: a current is warm if it is warmer than the ocean water it is currently flowing through, and cold if it is colder, not by any fixed temperature.`, kind: 'tip' },
    { content: `A current carries its starting temperature along its whole path, and keeps its warm or cold label as long as that comparison still holds true.`, kind: 'tip' },
    { content: `The ocean water next to a coastline is part of that coastline's climate: warmer offshore water keeps nearby air milder than latitude alone would predict, and colder offshore water keeps it cooler.`, kind: 'tip' },
    { content: `The warm Gulf Stream and North Atlantic Current keep northwestern Europe's winters far milder than most places at the same latitude.`, kind: 'tip' },
