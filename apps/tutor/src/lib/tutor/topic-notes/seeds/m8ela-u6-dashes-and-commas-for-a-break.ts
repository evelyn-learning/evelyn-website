/**
 * Grade 8 English Language Arts — Unit 6 CED 6.3: Dashes & Commas for a Break.
 *
 * Auto-extracted from the corresponding lesson plan
 * (evelyn.ms.m8ela.dashes-and-commas-for-a-break.v1). Hand-edit freely after extraction; bump
...
export const BASELINE_M8ELA_U6_DASHES_AND_COMMAS_FOR_A_BREAK: TopicNotesBaseline = {
  baselineId: 'evelyn.ms.m8ela.dashes-and-commas-for-a-break.v1',
  course: 'Grade 8 English Language Arts',
  cedUnit: 6,
  cedTopic: '6.3',
  cedTitle: 'Dashes & Commas for a Break',
  planId: 'evelyn.ms.m8ela.dashes-and-commas-for-a-break.v1',
  baselineVersion: 1,
  lastUpdatedAt: '2026-09-20',
  sources: [{ type: 'plan', planId: 'evelyn.ms.m8ela.dashes-and-commas-for-a-break.v1' }],
  theory: [
    { loId: 'm8ela.dashes-and-commas-for-a-break', content: `A BREAK IS A STOP INSIDE A SENTENCE, AFTER A COMPLETE THOUGHT. The sentence reaches a place where it could have ended, and then adds something: a turn, an afterthought, a detail that arrives late. "The bus was late again" is a complete thought. Add to it and you have made a break. "The bus was late again, the third time this week." "The bus was late again — the third time this week." Same words in the same order, and the only difference is the mark. That mark is the writer telling the reader how hard to land, and this lesson is about choosing it on purpose.` },
    { loId: 'm8ela.dashes-and-commas-for-a-break', content: `THE DASH MAKES A HARD STOP AND THROWS THE WEIGHT ONTO WHAT FOLLOWS. A single dash after a complete thought tells the reader to stop here, and then hits them with the rest. "Nobody moved — not one person." It is the mark for an abrupt turn, a late reveal, or a sharp piece of emphasis, and it works because the reader has to come to a halt before the last words arrive. The dash is the long mark, longer than the hyphen inside a word like "well-known", and the dash you are learning here stands alone: it comes after a complete thought and needs no partner later in the sentence.` },
    { loId: 'm8ela.dashes-and-commas-for-a-break', content: `THE COMMA MAKES A SOFT PAUSE AND KEEPS THE SENTENCE MOVING. With a comma the added words arrive in the same breath, quietly, without asking the reader to stop. "Ms. Reyes handed back the projects on Friday, one table at a time." Nothing is being announced. The detail slides in at the end and the sentence keeps its shape. This is the right choice far more often than the dash is, because most additions are not worth a full stop.` },
    { loId: 'm8ela.dashes-and-commas-for-a-break', content: `ONE QUESTION DECIDES WHETHER YOU EVEN HAVE A CHOICE: COULD THE WORDS AFTER THE BREAK STAND ALONE AS THEIR OWN SENTENCE? If they could, a comma cannot hold them, and you already know that error by name. WRONG: "The gym was locked, nobody had the key." CORRECT: "The gym was locked — nobody had the key." A period, a semicolon, or a comma with a joining word would all be correct there too, and you already have all three. The dash is a fourth way, and it is the one that keeps both halves inside a single sentence and drops the second half on the reader. If the words after the break could NOT stand alone, both marks are legal and the effect decides.` },
    { loId: 'm8ela.dashes-and-commas-for-a-break', content: `WHEN BOTH MARKS ARE LEGAL, CHOOSE BY THE EFFECT WANTED, AND TEST IT BY READING BOTH WAYS ALOUD. Say the sentence with a comma, then say it with a dash, and ask which one does what you want to the reader: keep moving, or stop and land. Two cautions go with the dash. It needs a complete thought in front of it, so a clause that begins with a starter word like "because" or "when" is not ready for one yet. And it gets its force from being rare, so a dash spent on something small promises weight the words after it do not carry.` },
    { loId: 'm8ela.dashes-and-commas-for-a-break', kind: 'definition', title: 'break', content: `a stop inside a sentence, made after a complete thought, with something added on the other side of it.` },
    { loId: 'm8ela.dashes-and-commas-for-a-break', kind: 'definition', title: 'dash', content: `the long mark that makes a break inside a sentence, longer than the hyphen inside a word like "well-known"; a single one after a complete thought marks an abrupt break or a sharp emphasis.` },
    { loId: 'm8ela.dashes-and-commas-for-a-break', kind: 'definition', title: 'pause', content: `the softer stop a comma makes at a break, which lets the added words arrive without stopping the reader.` },
    { loId: 'm8ela.dashes-and-commas-for-a-break', kind: 'definition', title: 'independent clause', content: `a group of words with a subject-verb pair that could stand alone as its own sentence; every break in this lesson comes after one.` },
    { loId: 'm8ela.dashes-and-commas-for-a-break', kind: 'definition', title: 'comma splice', content: `the error of holding two independent clauses together with a comma alone; a single dash can hold them and a comma cannot.` },
  ],
  methods: [
    {
      title: 'Worked read three breaks',
      steps: [
      ...
      example: { problem: `Each of these sentences makes a break after a complete thought. Say what the mark is doing to the reader, and say whether the writer could have used the other mark instead.

(1) "The lock was already open — someone had been there before us."
(2) "The gym filled up before six, mostly seventh graders."
(3) "The whole front row stood up — every single one of them."`, solution: `Sentence 1: the dash is holding as well as breaking, because both halves are complete thoughts and a comma cannot join them. Sentence 2: the comma makes a soft pause so that "mostly seventh graders" arrives quietly, and a dash would be legal but would announce a small detail. Sentence 3: both marks are legal and the dash is chosen, because the reader is meant to stop and land on "every single one of them".` },
      relatedLoIds: ['m8ela.dashes-and-commas-for-a-break'],
    },
    {
      title: 'Worked repair two breaks',
      steps: [
      ...
      example: { problem: `Two sentences from a student's story about a school fundraiser need work. Repair the break in each one, and say what decided the repair.

Sentence A: "We counted the cash box twice, the total was forty dollars short."
Sentence B: "Because the printer jammed twice — the posters went up a day late."`, solution: `Sentence A becomes "We counted the cash box twice — the total was forty dollars short." A comma cannot hold two complete thoughts, and of the marks that can, the dash is the one that keeps both halves in one sentence and stops the reader before the shortfall. Sentence B has two repairs: "Because the printer jammed twice, the posters went up a day late." drops the dash and closes the opening clause with a comma, and "The posters went up a day late — the printer jammed twice." keeps the dash by putting a complete thought in front of it.` },
      relatedLoIds: ['m8ela.dashes-and-commas-for-a-break'],
    },
  ],
  pointers: [
    { content: `Students often say "A comma is fine there, because I would only take a small breath at that spot." — Run the two questions first. Before the mark, "The heater was broken again" has a subject and a verb and could stand alone. After the mark, "the classroom never got above sixty degrees" could stand alone too. Two complete thoughts held together by a comma alone is the comma splice, and no amount of breathing makes it legal. WRONG: "The heater was broken again, the classroom never got above sixty degrees." CORRECT: "The heater was broken again — the classroom never got above sixty degrees." A period, a semicolon, or a comma with a joining word would each be correct here as well; the dash is the one that keeps both halves in a single sentence and drops the second half on the reader.`, kind: 'common-error' },
    { content: `Students often say "I used a dash because dashes are stronger, and I wanted that sentence to be strong." — Ask what actually arrives after the break. Here it is "around four", a small piece of information nobody needs to brace for, so the dash promises weight and then does not deliver it. CORRECT: "We got to the field early, around four." Save the dash for a break where the words after it earn a full stop: "We got to the field early — the gate was still locked." One more thing worth checking whenever you reach for a dash is what sits in FRONT of it, because a dash needs a complete thought there. WRONG: "Because we got to the field early — the gate was still locked." CORRECT: "Because we got to the field early, the gate was still locked."`, kind: 'common-error' },
    { content: `A break comes after a complete thought. Before you pick a mark, ask what could stand alone on each side of it.`, kind: 'tip' },
    { content: `The dash makes a hard stop and throws the weight onto what follows. "Nobody moved — not one person."`, kind: 'tip' },
    { content: `The comma makes a soft pause and keeps the sentence moving. "Ms. Reyes handed back the projects on Friday, one table at a time."`, kind: 'tip' },
    { content: `If the words after the break could stand alone as their own sentence, a comma cannot hold them. WRONG: "The gym was locked, nobody had the key." CORRECT: "The gym was locked — nobody had the key." A period, a semicolon, or a comma with a joining word would be correct there too; the dash is the one that keeps both halves inside one sentence.`, kind: 'tip' },
    { content: `If both marks are legal, choose by the effect wanted. Read the sentence both ways aloud and ask whether you want the reader to keep moving or to stop and land.`, kind: 'tip' },
    { content: `A dash needs a complete thought in front of it, and it wears out fast. WRONG: "Because the printer jammed twice — the posters went up a day late." CORRECT: "Because the printer jammed twice, the posters went up a day late."`, kind: 'tip' },
  ],
};
