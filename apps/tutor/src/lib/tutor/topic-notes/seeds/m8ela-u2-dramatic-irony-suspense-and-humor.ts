/**
 * Grade 8 English Language Arts — Unit 2 CED 2.2: Dramatic Irony, Suspense & Humor.
 *
 * Auto-extracted from the corresponding lesson plan
 * (evelyn.ms.m8ela.dramatic-irony-suspense-and-humor.v1). Hand-edit freely after extraction; bump
  ...
  methods: [
    {
      ...
      example: { problem: `Name the gap, say which line opens it, and name the effect it creates.

"By three o'clock the ice along the far shore had gone gray and soft in the sun, and a crack ran under the snow where nobody had walked yet. Theo, who had checked the forecast twice that morning, laced his skates on the near shore. 'Solid as a parking lot,' he told his little brother, and pushed off toward the middle."`, solution: `Dramatic irony: the first sentence tells the reader that the far ice "had gone gray and soft in the sun" with a crack under the snow, while Theo, who knows only the forecast, calls it "Solid as a parking lot," and the effect is suspense, because the gap closes on real danger in the middle of the lake and the reader can only wait for him to reach it.` },
      relatedLoIds: ['m8ela.dramatic-irony-suspense-and-humor'],
    },
    {
      title: 'Worked same gap two effects',
      steps: [
      ...
      example: { problem: `Here is one gap written two ways. Name the effect each version creates, and say exactly what changed.
...
VERSION B: "Marisol let herself in, dropped her bag by the door, and told her best friend on the phone that the crack in Dev's guitar had been there for months and that she had never once touched it. In the pantry, Dev ran his thumb along the crack that had not been there that morning, and waited for her to finish."`, solution: `Version A creates humor and Version B creates suspense. The gap is identical: the reader is in the pantry and Marisol is not. What changed is the stakes when the gap closes. A surprise party costs her nothing but a red face, while a brother running his thumb along the crack she just lied about costs her being caught in a lie.` },
      relatedLoIds: ['m8ela.dramatic-irony-suspense-and-humor'],
    },
  ],
  pointers: [
    { content: `Students often say "This is not dramatic irony, because nothing surprised me. I already knew about the truck." — Dramatic irony works only because the reader is not surprised. The story told you about the truck three sentences earlier on purpose, so that every time Ava says Jun is always late you would hear it differently than she does. The surprise belongs to the character, and it is still coming. Run the test from the lesson: can you point at the line that gave you the fact? Yes, the moving truck at dawn. Can Ava? No. That is the gap, and that is dramatic irony. If you HAD been surprised along with Ava, there would have been no gap, and the scene would have been a mystery instead.`, kind: 'common-error' },
    { content: `Students often say "It is dramatic irony, and the effect is humor, because Ava keeps checking her phone and insisting Jun is always late." — Ask what closes on Ava when the gap closes. Her friend left without a word, and every "Jun is always late" she tells herself is one more minute she has not found out. That is not a red face; that is a real loss, and the reader wants to tell her and cannot. That helpless wait is suspense, however brightly she checks her phone. The same repetition, if the story had told you Jun was hiding behind the bus shelter with a birthday cake, would have been humor. What the character feels never decides the effect. What the reader knows is waiting for her does.`, kind: 'common-error' },
    { content: `Dramatic irony is a gap: the reader knows a fact that a character does not. Point at the line that opened it. If you cannot, you have a hunch, not dramatic irony.`, kind: 'tip' },
    { content: `The gap is the mechanism, not the effect. The same gap can build suspense or humor, and the writer chooses by setting what it will cost the character when the gap closes.`, kind: 'tip' },
    { content: `A real cost waiting, danger, getting caught, a loss that matters, means suspense: you want to warn the character and cannot, and every confident word they say makes the wait worse.`, kind: 'tip' },
