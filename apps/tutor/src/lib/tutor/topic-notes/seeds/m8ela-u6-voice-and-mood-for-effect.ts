/**
 * Grade 8 English Language Arts — Unit 6 CED 6.2: Voice & Mood for Effect.
 *
 * Auto-extracted from the corresponding lesson plan
 * (evelyn.ms.m8ela.voice-and-mood-for-effect.v1). Hand-edit freely after extraction; bump
...
export const BASELINE_M8ELA_U6_VOICE_AND_MOOD_FOR_EFFECT: TopicNotesBaseline = {
  baselineId: 'evelyn.ms.m8ela.voice-and-mood-for-effect.v1',
  course: 'Grade 8 English Language Arts',
  cedUnit: 6,
  cedTopic: '6.2',
  cedTitle: 'Voice & Mood for Effect',
  planId: 'evelyn.ms.m8ela.voice-and-mood-for-effect.v1',
  baselineVersion: 1,
  lastUpdatedAt: '2026-09-20',
  sources: [{ type: 'plan', planId: 'evelyn.ms.m8ela.voice-and-mood-for-effect.v1' }],
  theory: [
    { loId: 'm8ela.voice-and-mood-for-effect', content: `NAME THE EFFECT FIRST. THE FORM COMES SECOND. None of these forms is an error, and none of them is better than the others on its own, so there is nothing to obey here and something to decide. The move is three steps, and the first is the one people skip. One: say in one sentence what the reader should walk away with — who did it, what happened, or that this is not so. Two: pick the form that produces that. Three: read both versions back and check that only the emphasis moved. If the two versions say different things about the world, you have changed the facts instead of the emphasis, and you have to start over.` },
    { loId: 'm8ela.voice-and-mood-for-effect', content: `ACTIVE PUTS THE ACTOR IN THE SUBJECT SEAT, AND THE SUBJECT SEAT IS THE LOUDEST ONE. Whatever sits there is what the reader remembers. So when the point of the sentence is the person — credit, blame, who to go ask, who made the call — the actor belongs in that seat: "Dev repaired the projector before third period." Naming the actor somewhere in the sentence is not the same as emphasizing the actor. "The projector was repaired by Dev before third period" names him and still hands the seat to the projector, so the reader walks away with the projector.` },
    { loId: 'm8ela.voice-and-mood-for-effect', content: `PASSIVE PUTS THE ACTION OR ITS RECEIVER IN THAT SEAT, AND THE DOER BECOMES OPTIONAL. Three jobs it does well. First, the receiver is what the paragraph is already about, so keeping it in the subject seat keeps the reader on one subject: a paragraph about the projector says "The projector was repaired before third period." Second, nobody knows who the doer is. Third, the doer is known and simply beside the point, the way it is in a set of instructions or a report about a thing rather than a person.` },
    { loId: 'm8ela.voice-and-mood-for-effect', content: `WHEN THE DOER IS UNKNOWN, LEAVE THE SEAT EMPTY INSTEAD OF FILLING IT WITH NOBODY. This is the passive job students most often miss. If you do not know who did it, the active voice forces you to put something in the subject seat, and the something is usually "somebody", "they" or "someone" — words that name no one and take the loudest position in the sentence to do it. The passive lets you drop the doer entirely and put the real news out front: "Every shelf in the closet was relabeled over the weekend" says more than "Somebody relabeled every shelf in the closet over the weekend", and it claims less.` },
    { loId: 'm8ela.voice-and-mood-for-effect', kind: 'framework', title: 'The conditional presents something as possible rather than settled', content: `THE CONDITIONAL PRESENTS SOMETHING AS POSSIBLE RATHER THAN SETTLED — AND IT NEEDS ITS CONDITION ON THE PAGE. Would, could and might tell the reader that what follows has not happened and may not: "If the grant comes through, the club would buy a second printer." Put the same idea in the plain indicative, "The club buys a second printer", and a reader takes it as a fact. The one requirement is that the reader can see what the possibility depends on. A "would" with no condition anywhere in sight leaves the reader holding half a sentence, wondering what has to happen first.` },
    { loId: 'm8ela.voice-and-mood-for-effect', content: `THE SUBJUNCTIVE MARKS A SITUATION THE WRITER KNOWS IS NOT SO. After "wish", and after an "if" that describes something untrue, the form is "were" for every subject, and that "were" is doing a job: it tells the reader you are not confused about the facts, you are imagining. WRONG: "I wish the gym was bigger." CORRECT: "I wish the gym were bigger." The plain past form turns up in conversation constantly; in writing, "were" is the form that marks the wish as something that is not so. A contrary-to-fact "if" clause pairs with the conditional in the other half: "If the gym were bigger, we would hold the fair inside."` },
    { loId: 'm8ela.voice-and-mood-for-effect', kind: 'definition', title: 'emphasis', content: `the idea a sentence puts out front, which the reader walks away with; the subject seat is where it is decided.` },
    { loId: 'm8ela.voice-and-mood-for-effect', kind: 'definition', title: 'active voice', content: `here, the choice that puts the actor in the subject seat; pick it when the reader should come away knowing who did the action.` },
    { loId: 'm8ela.voice-and-mood-for-effect', kind: 'definition', title: 'passive voice', content: `here, the choice that puts the action or its receiver in the subject seat and makes the doer optional; pick it when the receiver is the point, or when the doer is unknown or beside the point.` },
    { loId: 'm8ela.voice-and-mood-for-effect', kind: 'definition', title: 'conditional', content: `the would, could or might form; pick it to present something as possible rather than settled, and print the condition it depends on.` },
    { loId: 'm8ela.voice-and-mood-for-effect', kind: 'definition', title: 'contrary to fact', content: `describing a situation the writer knows is not so; the subjunctive "were" is the form that marks it, as in "If the gym were bigger."` },
  ],
  methods: [
    {
      title: 'Worked one event three effects',
      steps: [
      ...
      example: { problem: `One event, three different jobs. Here are the facts: Devin Okafor repainted the mural outside the gym over spring break.
...
(3) The building log records that the wall is finished, and the custodian writing it does not know who did the work.`, solution: `Effect 1 is active: "Devin Okafor repainted the mural outside the gym over spring break." Effect 2 is passive with the doer kept: "The mural outside the gym was repainted over spring break by Devin Okafor." Effect 3 is passive with the doer dropped: "The mural outside the gym was repainted at some point over spring break." All three report the same event; each one puts a different thing in the subject seat, and the third one declines to claim a doer the writer does not know.` },
    ...
    },
    {
      ...
      example: { problem: `Two drafts, two stated effects. Fix each draft so the form matches the effect.
...
Draft: "I wish the gym was bigger. If the gym is bigger, we hold the fair inside."`, solution: `Situation 1: "If the grant comes through, the club would buy a second printer, and every member could get machine time on Fridays." The conditional presents both as possible, and the "if" clause shows what they depend on. Situation 2: "I wish the gym were bigger. If the gym were bigger, we would hold the fair inside." The subjunctive "were" marks the bigger gym as contrary to fact, and "would" keeps the rest of the sentence inside that imagined situation.` },
      relatedLoIds: ['m8ela.voice-and-mood-for-effect'],
    },
  ],
  pointers: [
    { content: `Students often say "I crossed out every passive sentence in the article, because the passive voice is weak and the active voice is always the stronger choice." — There is no rule against the passive voice, and there is no rule for it either. Name the effect first and the choice follows. When the reader should come away with the person, the active is right: "Dev repaired the projector before third period." When the paragraph is about the projector, or when nobody knows who repaired it, the passive is right: "The projector was repaired before third period." A revision pass that deletes every passive sentence on sight throws away the one sentence a writer needs whenever the doer is unknown, and it forces the writer to open with "somebody" or "they", which names no one and takes the loudest seat in the sentence to do it.`, kind: 'common-error' },
    { content: `Students often say "The line "If I was in charge of the schedule, I will move the meetings to Thursday" can stay as it is, because everybody knows what it means." — Read the line as someone who does not know the writer. "If I was in charge" uses the plain past form, which a reader takes as a real possibility, and "I will move the meetings" is a flat promise, so the sentence sounds like a schedule change that is actually coming. The writer is not in charge and is not going to be. WRONG: "If I was in charge of the schedule, I will move the meetings to Thursday." CORRECT: "If I were in charge of the schedule, I would move the meetings to Thursday." The "were" marks the situation as contrary to fact, and "would" keeps what follows inside that imagined situation instead of promising it to a reader who will otherwise show up on Thursday.`, kind: 'common-error' },
    { content: `Both voices are correct and every mood is correct, so the question is never which one is allowed. It is which one does the job you want. Name the effect in one sentence, pick the form that produces it, then read both versions back and check that only the emphasis moved.`, kind: 'tip' },
    { content: `Whatever sits in the subject seat is what the reader remembers, so the active voice is the choice when the point is the person: "Dev repaired the projector before third period." Naming the actor in a "by" phrase is not the same as emphasizing the actor.`, kind: 'tip' },
    { content: `The passive voice puts the action or its receiver out front and makes the doer optional: "The projector was repaired before third period." Choose it when the receiver is what the paragraph is about, when the doer is unknown, or when the doer is beside the point.`, kind: 'tip' },
    { content: `When you do not know the doer, the passive lets you leave that seat empty instead of filling it with "somebody" or "they", which name no one and take the loudest position in the sentence to do it.`, kind: 'tip' },
    { content: `The conditional — would, could, might — presents something as possible rather than settled, and it only does that job when the reader can also see the condition it depends on.`, kind: 'tip' },
    { content: `The subjunctive marks a situation you know is not so. WRONG: "I wish the gym was bigger." CORRECT: "I wish the gym were bigger." A contrary-to-fact "if" clause takes the conditional in its other half: "If the gym were bigger, we would hold the fair inside."`, kind: 'tip' },
    { content: `Don't confuse **naming** the actor with **emphasizing** the actor. "The projector was repaired by Dev" names Dev but keeps the projector in the subject seat, so the reader remembers the projector, not Dev.`, kind: 'common-error' },
    { content: `When the doer is unknown, use passive voice and **leave the doer out entirely**. Don't force "somebody" or "they" into the subject seat just because you feel you need a subject. "Every shelf was labeled" is stronger than "Somebody labeled every shelf."`, kind: 'gotcha' },
    { content: `Always put the **condition on the page** when you use would, could, or might. "The club would buy a printer" without an "if" leaves the reader holding half a sentence. Write: "If the grant comes through, the club would buy a printer."`, kind: 'common-error' },
    { content: `After "wish" and after an "if" that describes something untrue, use **"were" for every subject**, even "I." WRONG: "I wish the gym was bigger." RIGHT: "I wish the gym were bigger." The "were" signals you know it's not actually so.`, kind: 'vocab-note' },
    { content: `**Name the effect first, then pick the form.** Don't ask "Which voice is correct?" or "Which mood should I use?" Ask "What should the reader come away with?" The form follows from the answer.`, kind: 'tip' },
    { content: `After you write a sentence in a different voice or mood, **read both versions side by side and check that only the emphasis changed, not the facts.** If the facts changed, start over—you've changed what the sentence claims, not how it emphasizes.`, kind: 'tip' },
    { content: `Don't treat verb forms as just decoration or style. The difference between "If I was in charge, I will move the meetings" and "If I were in charge, I would move the meetings" is the difference between a real plan and an imagined one—not just a preference.`, kind: 'gotcha' },
  ],
};
