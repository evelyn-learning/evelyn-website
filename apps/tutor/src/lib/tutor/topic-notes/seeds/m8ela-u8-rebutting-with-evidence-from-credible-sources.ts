/**
 * Grade 8 English Language Arts — Unit 8 CED 8.2: Rebutting with Evidence from Credible Sources.
 *
 * Auto-extracted from the corresponding lesson plan
 * (evelyn.ms.m8ela.rebutting-with-evidence-from-credible-sources.v1). Hand-edit freely after extraction; bump
...
export const BASELINE_M8ELA_U8_REBUTTING_WITH_EVIDENCE_FROM_CREDIBLE_SOURCES: TopicNotesBaseline = {
  ...
  theory: [
    ...
    { loId: 'm8ela.rebutting-with-evidence-from-credible-sources', kind: 'definition', title: 'rebuttal evidence', content: `the checkable fact, figure or observation a rebuttal points at, taken from a source the reader could go and look at.` },
    { loId: 'm8ela.rebutting-with-evidence-from-credible-sources', kind: 'definition', title: 'credible for this question', content: `worth believing about the one point being argued, because the source is in a position to know it and has no stake in the answer.` },
    { loId: 'm8ela.rebutting-with-evidence-from-credible-sources', kind: 'definition', title: 'limit', content: `the boundary a piece of evidence comes with — who was counted, where, when, and for how long. It is part of what the evidence says.` },
    { loId: 'm8ela.rebutting-with-evidence-from-credible-sources', kind: 'definition', title: 'overstating', content: `presenting evidence as stronger than the source states it, by rounding a figure up, widening the group it covers, or leaving off the limit.` },
    { loId: 'm8ela.rebutting-with-evidence-from-credible-sources', kind: 'definition', title: 'misquoting', content: `putting words inside quotation marks that a source did not use, or quoting its words while cutting the part that qualified them.` },
  ],
  methods: [
    {
      title: 'Worked build the evidence backed rebuttal',
      steps: [
      ...
      example: { problem: `A student is arguing that Bridgewater Middle School should keep the makerspace open during lunch. Build the rebuttal.
...
Source 2 — a post in an eighth-grade group chat that reads, "the makerspace is always packed at lunch."`, solution: `The rebuttal reads: "Some teachers say the makerspace is too crowded at lunch for anyone to get a seat. The sign-in binder the teacher on duty keeps at the door tells a different story: over the past month, the busiest lunch period drew 14 students into a room with 22 seats, which left eight seats empty on its fullest day." The binder settles a question about how many and the group chat post cannot, every figure is stated as the binder gives it, and the month the binder covers is attached to the claim.` },
    ...
    },
    {
      ...
      example: { problem: `A student is arguing that the town should keep the skate park lights on until nine. Repair the rebuttal draft below.
...
Draft rebuttal: "Neighbors say the lit park draws noise late into the evening, but the Parks Department found the park empty after 8:30, and a review page online says the crowds thin out right after dinner anyway."`, solution: `The repaired rebuttal reads: "Some neighbors say the lit park draws noise late into the evening. In the six weeks the Fairvale Parks Department counted last fall, taking a count every half hour between six and nine, the number of skaters after 8:30 never went above five." The draft overstated the finding as an empty park, dropped the six-week limit, and leaned on an unsigned review page standing beside a source that had already done the counting.` },
      relatedLoIds: ['m8ela.rebutting-with-evidence-from-credible-sources'],
    },
  ],
  pointers: [
    { content: `Students often say "The draft is fine, because ninety-six is close enough to a hundred and the point comes out the same either way." — Ninety-six is not well over a hundred; it is under a hundred, so the sentence is false as written and it is false in the direction that helps the writer, which is the worst direction for a figure to be wrong in. Notice what the writer gave up. The rebuttal was already winning with 96, because 96 people is not "almost nobody" by any reading, and an exact figure is the more convincing sentence precisely because it was obviously counted. WRONG: "the rec center counted well over a hundred people crossing mid-block". CORRECT: "the rec center counted 96 people crossing mid-block". The first driver who asks to see the tally now has a fair complaint about the writer instead of an answer about the crosswalk.`, kind: 'common-error' },
    { content: `Students often say "The missing two weeks do not matter, because the rec center is a reliable source and the count came from it." — A reliable source is reliable about what it actually measured. This tally covers the two weeks before spring break, at one desk, at one crossing. Written without that boundary, the sentence sounds like a standing fact about every week of the year, which the rec center never claimed and cannot back. Carrying the limit costs the rebuttal nothing: "96 people crossed mid-block in the two weeks the front desk kept the tally" is a sentence the rec center will stand behind, and the version without the limit is one it will not. Where a source came from is a claim about the source, never permission for what the writer does with it afterward.`, kind: 'common-error' },
    { content: `The two moves are unchanged: state the strongest thing the other side would say, then answer it. What is new is that the answer arrives with a fact, a figure, or an observation attached, taken from a source the reader could go and check.`, kind: 'tip' },
    { content: `Say the counterclaim reason in your own words first. The evidence has to hit that reason. A true fact that answers a different objection reads as a change of subject.`, kind: 'tip' },
    { content: `Choose the source that is in a position to settle this one question and has no stake in the answer. A rebuttal is only as strong as the source it rests on, and stating it with more confidence does not patch a weak one.`, kind: 'tip' },
    { content: `State the figure the way the source states it. WRONG: "close to fifty bicycles". CORRECT: "31 bicycles". A stretched number hands the other side the easiest reply available in any argument, which is to go and look at the source you named.`, kind: 'tip' },
    { content: `The limit travels with the figure: who was counted, where, when, and for how long. Drop it and you have made a larger claim than your source made, and your source cannot back it.`, kind: 'tip' },
    { content: `If you put words inside quotation marks, they have to be the words the source used, with the part that limited them still attached. When you cannot reproduce the wording exactly, drop the quotation marks, say what the source shows in your own sentence, and name it.`, kind: 'tip' },
  ],
};
