...
14. Search every spoken field and `los[0].description` for "Grade 7", "Grade 6", "G7", "last year", "Deepens" — none may appear outside the doc comment. ("already know" was struck from this list 2026-09-19: ruling 18 makes "you already know …" the HOUSE convention for prior learning; the ban and the ruling contradicted each other and a batch-1 agent caught it.)
