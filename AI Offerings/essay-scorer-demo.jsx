...
// Essay Scoring & Feedback Demo
// This component provides a complete interactive demo for B2B prospects
...
export default function EssayScoringDemo() {
  ...
  const [essayType, setEssayType] = useState('sat'); // sat, act, college
...
"""`;
    ...
    try {
      ...
      setError(`Error: ${err.message}. Make sure the API is properly configured.`);
    } finally {
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            ...
            <textarea
              ...
              className="w-full h-64 p-4 border border-gray-200 rounded-xl resize-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-700"
            />
            ...
            <button
              ...
              className="w-full mt-4 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-indigo-700 transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isAnalyzing ? (
                <>
            ...
            {feedback && (
              <div className="space-y-6 overflow-y-auto max-h-[600px] pr-2">
                ...
                <div className="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl p-6 text-white">
                  ...
                  <p className="mt-4 text-blue-100 text-sm">{feedback.overallAssessment}</p>
                </div>
                ...
                {feedback.rewriteExample && (
                  <div>
                    <h3 className="font-semibold text-gray-800 mb-3">✏️ Sentence Improvement Example</h3>
                    <div className="space-y-3">
                    ...
                    {feedback.categories.map((cat, idx) => (
                      <details key={idx} className="border border-gray-200 rounded-lg">
                        ...
                        <div className="p-4 pt-0 space-y-3">
                          ...
                          <div>
                            <p className="text-xs font-medium text-blue-600 mb-2">SUGGESTIONS</p>
                            <ul className="space-y-1">
